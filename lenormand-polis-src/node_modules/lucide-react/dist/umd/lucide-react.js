...
(function (global, factory) {
  ...
  const AArrowDown = createLucideIcon("a-arrow-down", __iconNode$q3);
  ...
  const AArrowUp = createLucideIcon("a-arrow-up", __iconNode$q2);
  ...
  const ALargeSmall = createLucideIcon("a-large-small", __iconNode$q1);
  ...
  const Accessibility = createLucideIcon("accessibility", __iconNode$q0);
  ...
  const AirVent = createLucideIcon("air-vent", __iconNode$p_);
  ...
  const Airplay = createLucideIcon("airplay", __iconNode$pZ);
  ...
  const AlarmClockCheck = createLucideIcon("alarm-clock-check", __iconNode$pY);
  ...
  const AlarmClockMinus = createLucideIcon("alarm-clock-minus", __iconNode$pX);
  ...
  const AlarmClockOff = createLucideIcon("alarm-clock-off", __iconNode$pW);
  ...
  const AlarmClockPlus = createLucideIcon("alarm-clock-plus", __iconNode$pV);
  ...
  const AlarmClock = createLucideIcon("alarm-clock", __iconNode$pU);
  ...
  const AlarmSmoke = createLucideIcon("alarm-smoke", __iconNode$pT);

  const __iconNode$pS = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", ry: "2", key: "1m3agn" }],
    ["polyline", { points: "11 3 11 11 14 8 17 11 17 3", key: "1wcwz3" }]
  ];
  const Album = createLucideIcon("album", __iconNode$pS);
  ...
  const AlignCenterHorizontal = createLucideIcon("align-center-horizontal", __iconNode$pR);
  ...
  const AlignCenterVertical = createLucideIcon("align-center-vertical", __iconNode$pQ);
  ...
  const AlignEndHorizontal = createLucideIcon("align-end-horizontal", __iconNode$pP);
  ...
  const AlignEndVertical = createLucideIcon("align-end-vertical", __iconNode$pO);
  ...
  const AlignHorizontalJustifyEnd = createLucideIcon("align-horizontal-justify-end", __iconNode$pJ);
  ...
  const AlignHorizontalJustifyStart = createLucideIcon("align-horizontal-justify-start", __iconNode$pI);
  ...
  const AlignHorizontalSpaceAround = createLucideIcon("align-horizontal-space-around", __iconNode$pH);
  ...
  const AlignHorizontalSpaceBetween = createLucideIcon("align-horizontal-space-between", __iconNode$pG);
  ...
  const AlignStartHorizontal = createLucideIcon("align-start-horizontal", __iconNode$pF);
  ...
  const AlignStartVertical = createLucideIcon("align-start-vertical", __iconNode$pE);
  ...
  const AlignVerticalDistributeEnd = createLucideIcon("align-vertical-distribute-end", __iconNode$pC);
  ...
  const AlignVerticalJustifyEnd = createLucideIcon("align-vertical-justify-end", __iconNode$pA);
  ...
  const AlignVerticalJustifyCenter = createLucideIcon("align-vertical-justify-center", __iconNode$pz);
  ...
  const AlignVerticalJustifyStart = createLucideIcon("align-vertical-justify-start", __iconNode$py);
  ...
  const AlignVerticalSpaceAround = createLucideIcon("align-vertical-space-around", __iconNode$px);
  ...
  const AlignVerticalSpaceBetween = createLucideIcon("align-vertical-space-between", __iconNode$pw);
  ...
  const Ambulance = createLucideIcon("ambulance", __iconNode$pv);
  ...
  const Ampersand = createLucideIcon("ampersand", __iconNode$pu);
  ...
  const Ampersands = createLucideIcon("ampersands", __iconNode$pt);
  ...
  const Amphora = createLucideIcon("amphora", __iconNode$ps);
  ...
  const Angry = createLucideIcon("angry", __iconNode$pr);
  ...
  const Anchor = createLucideIcon("anchor", __iconNode$pq);
  ...
  const Annoyed = createLucideIcon("annoyed", __iconNode$pp);
  ...
  const Antenna = createLucideIcon("antenna", __iconNode$po);
  ...
  const Anvil = createLucideIcon("anvil", __iconNode$pn);
  ...
  const Aperture = createLucideIcon("aperture", __iconNode$pm);
  ...
  const AppWindowMac = createLucideIcon("app-window-mac", __iconNode$pl);
  ...
  const AppWindow = createLucideIcon("app-window", __iconNode$pk);
  ...
  const Apple = createLucideIcon("apple", __iconNode$pj);
  ...
  const ArchiveRestore = createLucideIcon("archive-restore", __iconNode$pi);
  ...
  const ArchiveX = createLucideIcon("archive-x", __iconNode$ph);
  ...
  const Archive = createLucideIcon("archive", __iconNode$pg);
  ...
  const Armchair = createLucideIcon("armchair", __iconNode$pf);
  ...
  const ArrowBigDownDash = createLucideIcon("arrow-big-down-dash", __iconNode$pe);
  ...
  const ArrowBigDown = createLucideIcon("arrow-big-down", __iconNode$pd);
  ...
  const ArrowBigLeftDash = createLucideIcon("arrow-big-left-dash", __iconNode$pc);
  ...
  const ArrowBigLeft = createLucideIcon("arrow-big-left", __iconNode$pb);
  ...
  const ArrowBigRightDash = createLucideIcon("arrow-big-right-dash", __iconNode$pa);
  ...
  const ArrowBigRight = createLucideIcon("arrow-big-right", __iconNode$p9);
  ...
  const ArrowBigUpDash = createLucideIcon("arrow-big-up-dash", __iconNode$p8);
  ...
  const ArrowBigUp = createLucideIcon("arrow-big-up", __iconNode$p7);
  ...
  const ArrowDown01 = createLucideIcon("arrow-down-0-1", __iconNode$p6);
  ...
  const ArrowDown10 = createLucideIcon("arrow-down-1-0", __iconNode$p5);
  ...
  const ArrowDownAZ = createLucideIcon("arrow-down-a-z", __iconNode$p4);
  ...
  const ArrowDownFromLine = createLucideIcon("arrow-down-from-line", __iconNode$p3);

  const __iconNode$p2 = [
    ["path", { d: "M17 7 7 17", key: "15tmo1" }],
    ["path", { d: "M17 17H7V7", key: "1org7z" }]
  ];
  const ArrowDownLeft = createLucideIcon("arrow-down-left", __iconNode$p2);
  ...
  const ArrowDownNarrowWide = createLucideIcon("arrow-down-narrow-wide", __iconNode$p1);

  const __iconNode$p0 = [
    ["path", { d: "m7 7 10 10", key: "1fmybs" }],
    ["path", { d: "M17 7v10H7", key: "6fjiku" }]
  ];
  const ArrowDownRight = createLucideIcon("arrow-down-right", __iconNode$p0);
  ...
  const ArrowDownToDot = createLucideIcon("arrow-down-to-dot", __iconNode$o$);
  ...
  const ArrowDownToLine = createLucideIcon("arrow-down-to-line", __iconNode$o_);
  ...
  const ArrowDownUp = createLucideIcon("arrow-down-up", __iconNode$oZ);
  ...
  const ArrowDownWideNarrow = createLucideIcon("arrow-down-wide-narrow", __iconNode$oY);
  ...
  const ArrowDownZA = createLucideIcon("arrow-down-z-a", __iconNode$oX);

  const __iconNode$oW = [
    ["path", { d: "M12 5v14", key: "s699le" }],
    ["path", { d: "m19 12-7 7-7-7", key: "1idqje" }]
  ];
  const ArrowDown = createLucideIcon("arrow-down", __iconNode$oW);
  ...
  const ArrowLeftFromLine = createLucideIcon("arrow-left-from-line", __iconNode$oV);
  ...
  const ArrowLeftRight = createLucideIcon("arrow-left-right", __iconNode$oU);
  ...
  const ArrowLeftToLine = createLucideIcon("arrow-left-to-line", __iconNode$oT);

  const __iconNode$oS = [
    ["path", { d: "m12 19-7-7 7-7", key: "1l729n" }],
    ["path", { d: "M19 12H5", key: "x3x0zl" }]
  ];
  const ArrowLeft = createLucideIcon("arrow-left", __iconNode$oS);
  ...
  const ArrowRightFromLine = createLucideIcon("arrow-right-from-line", __iconNode$oR);
  ...
  const ArrowRightLeft = createLucideIcon("arrow-right-left", __iconNode$oQ);

  const __iconNode$oP = [
    ["path", { d: "M5 12h14", key: "1ays0h" }],
    ["path", { d: "m12 5 7 7-7 7", key: "xquz4c" }]
  ];
  const ArrowRight = createLucideIcon("arrow-right", __iconNode$oP);
  ...
  const ArrowRightToLine = createLucideIcon("arrow-right-to-line", __iconNode$oO);
  ...
  const ArrowUp01 = createLucideIcon("arrow-up-0-1", __iconNode$oN);
  ...
  const ArrowUp10 = createLucideIcon("arrow-up-1-0", __iconNode$oM);
  ...
  const ArrowUpAZ = createLucideIcon("arrow-up-a-z", __iconNode$oL);
  ...
  const ArrowUpDown = createLucideIcon("arrow-up-down", __iconNode$oK);
  ...
  const ArrowUpFromDot = createLucideIcon("arrow-up-from-dot", __iconNode$oJ);
  ...
  const ArrowUpFromLine = createLucideIcon("arrow-up-from-line", __iconNode$oI);

  const __iconNode$oH = [
    ["path", { d: "M7 17V7h10", key: "11bw93" }],
    ["path", { d: "M17 17 7 7", key: "2786uv" }]
  ];
  const ArrowUpLeft = createLucideIcon("arrow-up-left", __iconNode$oH);
  ...
  const ArrowUpNarrowWide = createLucideIcon("arrow-up-narrow-wide", __iconNode$oG);

  const __iconNode$oF = [
    ["path", { d: "M7 7h10v10", key: "1tivn9" }],
    ["path", { d: "M7 17 17 7", key: "1vkiza" }]
  ];
  const ArrowUpRight = createLucideIcon("arrow-up-right", __iconNode$oF);
  ...
  const ArrowUpToLine = createLucideIcon("arrow-up-to-line", __iconNode$oE);
  ...
  const ArrowUpWideNarrow = createLucideIcon("arrow-up-wide-narrow", __iconNode$oD);
  ...
  const ArrowUpZA = createLucideIcon("arrow-up-z-a", __iconNode$oC);

  const __iconNode$oB = [
    ["path", { d: "m5 12 7-7 7 7", key: "hav0vg" }],
    ["path", { d: "M12 19V5", key: "x0mq9r" }]
  ];
  const ArrowUp = createLucideIcon("arrow-up", __iconNode$oB);
  ...
  const ArrowsUpFromLine = createLucideIcon("arrows-up-from-line", __iconNode$oA);
  ...
  const Asterisk = createLucideIcon("asterisk", __iconNode$oz);

  const __iconNode$oy = [
    ["circle", { cx: "12", cy: "12", r: "4", key: "4exip2" }],
    ["path", { d: "M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-4 8", key: "7n84p3" }]
  ];
  const AtSign = createLucideIcon("at-sign", __iconNode$oy);
  ...
  const Atom = createLucideIcon("atom", __iconNode$ox);
  ...
  const AudioLines = createLucideIcon("audio-lines", __iconNode$ow);
  ...
  const AudioWaveform = createLucideIcon("audio-waveform", __iconNode$ov);
  ...
  const Award = createLucideIcon("award", __iconNode$ou);
  ...
  const Axe = createLucideIcon("axe", __iconNode$ot);
  ...
  const Axis3d = createLucideIcon("axis-3d", __iconNode$os);
  ...
  const Backpack = createLucideIcon("backpack", __iconNode$or);
  ...
  const Baby = createLucideIcon("baby", __iconNode$oq);
  ...
  const BadgeAlert = createLucideIcon("badge-alert", __iconNode$op);
  ...
  const BadgeCent = createLucideIcon("badge-cent", __iconNode$oo);
  ...
  const BadgeCheck = createLucideIcon("badge-check", __iconNode$on);
  ...
  const BadgeDollarSign = createLucideIcon("badge-dollar-sign", __iconNode$om);
  ...
  const BadgeEuro = createLucideIcon("badge-euro", __iconNode$ol);
  ...
  const BadgeIndianRupee = createLucideIcon("badge-indian-rupee", __iconNode$ok);
  ...
  const BadgeInfo = createLucideIcon("badge-info", __iconNode$oj);
  ...
  const BadgeJapaneseYen = createLucideIcon("badge-japanese-yen", __iconNode$oi);
  ...
  const BadgeMinus = createLucideIcon("badge-minus", __iconNode$oh);
  ...
  const BadgePercent = createLucideIcon("badge-percent", __iconNode$og);
  ...
  const BadgePlus = createLucideIcon("badge-plus", __iconNode$of);
  ...
  const BadgePoundSterling = createLucideIcon("badge-pound-sterling", __iconNode$oe);
  ...
  const BadgeQuestionMark = createLucideIcon("badge-question-mark", __iconNode$od);
  ...
  const BadgeRussianRuble = createLucideIcon("badge-russian-ruble", __iconNode$oc);
  ...
  const BadgeSwissFranc = createLucideIcon("badge-swiss-franc", __iconNode$ob);
  ...
  const BadgeTurkishLira = createLucideIcon("badge-turkish-lira", __iconNode$oa);
  ...
  const BadgeX = createLucideIcon("badge-x", __iconNode$o9);
  ...
  const BaggageClaim = createLucideIcon("baggage-claim", __iconNode$o8);
  ...
  const Badge = createLucideIcon("badge", __iconNode$o7);
  ...
  const Balloon = createLucideIcon("balloon", __iconNode$o6);

  const __iconNode$o5 = [
    ["path", { d: "M4.929 4.929 19.07 19.071", key: "196cmz" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Ban = createLucideIcon("ban", __iconNode$o5);
  ...
  const Banana = createLucideIcon("banana", __iconNode$o4);
  ...
  const BanknoteArrowDown = createLucideIcon("banknote-arrow-down", __iconNode$o3);
  ...
  const Bandage = createLucideIcon("bandage", __iconNode$o2);
  ...
  const BanknoteArrowUp = createLucideIcon("banknote-arrow-up", __iconNode$o1);
  ...
  const BanknoteX = createLucideIcon("banknote-x", __iconNode$o0);
  ...
  const Barcode = createLucideIcon("barcode", __iconNode$n$);
  ...
  const Banknote = createLucideIcon("banknote", __iconNode$n_);
  ...
  const Barrel = createLucideIcon("barrel", __iconNode$nZ);
  ...
  const Baseline = createLucideIcon("baseline", __iconNode$nY);
  ...
  const Bath = createLucideIcon("bath", __iconNode$nX);
  ...
  const BatteryCharging = createLucideIcon("battery-charging", __iconNode$nW);
  ...
  const BatteryFull = createLucideIcon("battery-full", __iconNode$nV);
  ...
  const BatteryLow = createLucideIcon("battery-low", __iconNode$nU);
  ...
  const BatteryMedium = createLucideIcon("battery-medium", __iconNode$nT);
  ...
  const BatteryPlus = createLucideIcon("battery-plus", __iconNode$nS);
  ...
  const BatteryWarning = createLucideIcon("battery-warning", __iconNode$nR);
  ...
  const Beaker = createLucideIcon("beaker", __iconNode$nQ);

  const __iconNode$nP = [
    ["path", { d: "M 22 14 L 22 10", key: "nqc4tb" }],
    ["rect", { x: "2", y: "6", width: "16", height: "12", rx: "2", key: "13zb55" }]
  ];
  const Battery = createLucideIcon("battery", __iconNode$nP);
  ...
  const BeanOff = createLucideIcon("bean-off", __iconNode$nO);
  ...
  const Bean = createLucideIcon("bean", __iconNode$nN);
  ...
  const BedDouble = createLucideIcon("bed-double", __iconNode$nM);
  ...
  const BedSingle = createLucideIcon("bed-single", __iconNode$nL);
  ...
  const Bed = createLucideIcon("bed", __iconNode$nK);
  ...
  const Beef = createLucideIcon("beef", __iconNode$nJ);
  ...
  const BeerOff = createLucideIcon("beer-off", __iconNode$nI);
  ...
  const BellDot = createLucideIcon("bell-dot", __iconNode$nH);
  ...
  const Beer = createLucideIcon("beer", __iconNode$nG);
  ...
  const BellElectric = createLucideIcon("bell-electric", __iconNode$nF);
  ...
  const BellMinus = createLucideIcon("bell-minus", __iconNode$nE);
  ...
  const BellOff = createLucideIcon("bell-off", __iconNode$nD);
  ...
  const BellPlus = createLucideIcon("bell-plus", __iconNode$nC);
  ...
  const BellRing = createLucideIcon("bell-ring", __iconNode$nB);
  ...
  const Bell = createLucideIcon("bell", __iconNode$nA);
  ...
  const BetweenHorizontalEnd = createLucideIcon("between-horizontal-end", __iconNode$nz);
  ...
  const BetweenHorizontalStart = createLucideIcon("between-horizontal-start", __iconNode$ny);
  ...
  const BetweenVerticalEnd = createLucideIcon("between-vertical-end", __iconNode$nx);
  ...
  const BetweenVerticalStart = createLucideIcon("between-vertical-start", __iconNode$nw);
  ...
  const BicepsFlexed = createLucideIcon("biceps-flexed", __iconNode$nv);
  ...
  const Bike = createLucideIcon("bike", __iconNode$nu);
  ...
  const Binary = createLucideIcon("binary", __iconNode$nt);
  ...
  const Binoculars = createLucideIcon("binoculars", __iconNode$ns);
  ...
  const Biohazard = createLucideIcon("biohazard", __iconNode$nr);
  ...
  const Bird = createLucideIcon("bird", __iconNode$nq);
  ...
  const Birdhouse = createLucideIcon("birdhouse", __iconNode$np);
  ...
  const Bitcoin = createLucideIcon("bitcoin", __iconNode$no);

  const __iconNode$nn = [
    ["circle", { cx: "9", cy: "9", r: "7", key: "p2h5vp" }],
    ["circle", { cx: "15", cy: "15", r: "7", key: "19ennj" }]
  ];
  const Blend = createLucideIcon("blend", __iconNode$nn);
  ...
  const Blinds = createLucideIcon("blinds", __iconNode$nm);
  ...
  const Blocks = createLucideIcon("blocks", __iconNode$nl);
  ...
  const BluetoothConnected = createLucideIcon("bluetooth-connected", __iconNode$nk);
  ...
  const BluetoothOff = createLucideIcon("bluetooth-off", __iconNode$nj);
  ...
  const BluetoothSearching = createLucideIcon("bluetooth-searching", __iconNode$ni);
  ...
  const Bold = createLucideIcon("bold", __iconNode$nh);

  const __iconNode$ng = [["path", { d: "m7 7 10 10-5 5V2l5 5L7 17", key: "1q5490" }]];
  const Bluetooth = createLucideIcon("bluetooth", __iconNode$ng);
  ...
  const Bolt = createLucideIcon("bolt", __iconNode$nf);
  ...
  const Bone = createLucideIcon("bone", __iconNode$ne);
  ...
  const Bomb = createLucideIcon("bomb", __iconNode$nd);
  ...
  const BookA = createLucideIcon("book-a", __iconNode$nc);
  ...
  const BookAlert = createLucideIcon("book-alert", __iconNode$nb);
  ...
  const BookAudio = createLucideIcon("book-audio", __iconNode$na);
  ...
  const BookCheck = createLucideIcon("book-check", __iconNode$n9);
  ...
  const BookCopy = createLucideIcon("book-copy", __iconNode$n8);
  ...
  const BookDashed = createLucideIcon("book-dashed", __iconNode$n7);
  ...
  const BookDown = createLucideIcon("book-down", __iconNode$n6);
  ...
  const BookHeadphones = createLucideIcon("book-headphones", __iconNode$n5);
  ...
  const BookHeart = createLucideIcon("book-heart", __iconNode$n4);
  ...
  const BookImage = createLucideIcon("book-image", __iconNode$n3);
  ...
  const BookKey = createLucideIcon("book-key", __iconNode$n2);
  ...
  const BookLock = createLucideIcon("book-lock", __iconNode$n1);
  ...
  const BookMinus = createLucideIcon("book-minus", __iconNode$n0);
  ...
  const BookMarked = createLucideIcon("book-marked", __iconNode$m$);
  ...
  const BookOpenCheck = createLucideIcon("book-open-check", __iconNode$m_);
  ...
  const BookOpen = createLucideIcon("book-open", __iconNode$mZ);
  ...
  const BookOpenText = createLucideIcon("book-open-text", __iconNode$mY);
  ...
  const BookPlus = createLucideIcon("book-plus", __iconNode$mX);
  ...
  const BookSearch = createLucideIcon("book-search", __iconNode$mW);
  ...
  const BookText = createLucideIcon("book-text", __iconNode$mV);
  ...
  const BookType = createLucideIcon("book-type", __iconNode$mU);
  ...
  const BookUp2 = createLucideIcon("book-up-2", __iconNode$mT);
  ...
  const BookUp = createLucideIcon("book-up", __iconNode$mS);
  ...
  const BookUser = createLucideIcon("book-user", __iconNode$mR);
  ...
  const BookX = createLucideIcon("book-x", __iconNode$mQ);
  ...
  const Book = createLucideIcon("book", __iconNode$mP);
  ...
  const BookmarkCheck = createLucideIcon("bookmark-check", __iconNode$mO);
  ...
  const BookmarkMinus = createLucideIcon("bookmark-minus", __iconNode$mN);
  ...
  const BookmarkPlus = createLucideIcon("bookmark-plus", __iconNode$mM);
  ...
  const BookmarkX = createLucideIcon("bookmark-x", __iconNode$mL);
  ...
  const Bookmark = createLucideIcon("bookmark", __iconNode$mK);
  ...
  const BoomBox = createLucideIcon("boom-box", __iconNode$mJ);
  ...
  const BotMessageSquare = createLucideIcon("bot-message-square", __iconNode$mI);
  ...
  const BotOff = createLucideIcon("bot-off", __iconNode$mH);
  ...
  const Bot = createLucideIcon("bot", __iconNode$mG);
  ...
  const BowArrow = createLucideIcon("bow-arrow", __iconNode$mF);
  ...
  const BottleWine = createLucideIcon("bottle-wine", __iconNode$mE);
  ...
  const Box = createLucideIcon("box", __iconNode$mD);
  ...
  const Boxes = createLucideIcon("boxes", __iconNode$mC);
  ...
  const BrainCircuit = createLucideIcon("brain-circuit", __iconNode$mz);
  ...
  const BrainCog = createLucideIcon("brain-cog", __iconNode$my);
  ...
  const Brain = createLucideIcon("brain", __iconNode$mx);
  ...
  const BrickWallFire = createLucideIcon("brick-wall-fire", __iconNode$mw);
  ...
  const BrickWallShield = createLucideIcon("brick-wall-shield", __iconNode$mv);
  ...
  const BrickWall = createLucideIcon("brick-wall", __iconNode$mu);
  ...
  const BriefcaseBusiness = createLucideIcon("briefcase-business", __iconNode$mt);
  ...
  const BriefcaseConveyorBelt = createLucideIcon("briefcase-conveyor-belt", __iconNode$ms);
  ...
  const BriefcaseMedical = createLucideIcon("briefcase-medical", __iconNode$mr);

  const __iconNode$mq = [
    ["path", { d: "M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16", key: "jecpp" }],
    ["rect", { width: "20", height: "14", x: "2", y: "6", rx: "2", key: "i6l2r4" }]
  ];
  const Briefcase = createLucideIcon("briefcase", __iconNode$mq);
  ...
  const BringToFront = createLucideIcon("bring-to-front", __iconNode$mp);
  ...
  const Brush = createLucideIcon("brush", __iconNode$mo);
  ...
  const BrushCleaning = createLucideIcon("brush-cleaning", __iconNode$mn);
  ...
  const Bubbles = createLucideIcon("bubbles", __iconNode$mm);
  ...
  const BugOff = createLucideIcon("bug-off", __iconNode$ml);
  ...
  const BugPlay = createLucideIcon("bug-play", __iconNode$mk);
  ...
  const Bug = createLucideIcon("bug", __iconNode$mj);
  ...
  const Building2 = createLucideIcon("building-2", __iconNode$mi);
  ...
  const Building = createLucideIcon("building", __iconNode$mh);
  ...
  const BusFront = createLucideIcon("bus-front", __iconNode$mg);
  ...
  const Bus = createLucideIcon("bus", __iconNode$mf);
  ...
  const CableCar = createLucideIcon("cable-car", __iconNode$me);
  ...
  const Cable = createLucideIcon("cable", __iconNode$md);
  ...
  const CakeSlice = createLucideIcon("cake-slice", __iconNode$mc);
  ...
  const Cake = createLucideIcon("cake", __iconNode$mb);
  ...
  const Calculator = createLucideIcon("calculator", __iconNode$ma);
  ...
  const Calendar1 = createLucideIcon("calendar-1", __iconNode$m9);
  ...
  const CalendarArrowDown = createLucideIcon("calendar-arrow-down", __iconNode$m8);
  ...
  const CalendarArrowUp = createLucideIcon("calendar-arrow-up", __iconNode$m7);
  ...
  const CalendarCheck2 = createLucideIcon("calendar-check-2", __iconNode$m6);
  ...
  const CalendarClock = createLucideIcon("calendar-clock", __iconNode$m5);
  ...
  const CalendarCheck = createLucideIcon("calendar-check", __iconNode$m4);
  ...
  const CalendarCog = createLucideIcon("calendar-cog", __iconNode$m3);
  ...
  const CalendarDays = createLucideIcon("calendar-days", __iconNode$m2);
  ...
  const CalendarFold = createLucideIcon("calendar-fold", __iconNode$m1);
  ...
  const CalendarHeart = createLucideIcon("calendar-heart", __iconNode$m0);
  ...
  const CalendarMinus2 = createLucideIcon("calendar-minus-2", __iconNode$l$);
  ...
  const CalendarMinus = createLucideIcon("calendar-minus", __iconNode$l_);
  ...
  const CalendarOff = createLucideIcon("calendar-off", __iconNode$lZ);
  ...
  const CalendarPlus2 = createLucideIcon("calendar-plus-2", __iconNode$lY);
  ...
  const CalendarPlus = createLucideIcon("calendar-plus", __iconNode$lX);
  ...
  const CalendarRange = createLucideIcon("calendar-range", __iconNode$lW);
  ...
  const CalendarSearch = createLucideIcon("calendar-search", __iconNode$lV);
  ...
  const CalendarX2 = createLucideIcon("calendar-x-2", __iconNode$lU);
  ...
  const CalendarSync = createLucideIcon("calendar-sync", __iconNode$lT);
  ...
  const CalendarX = createLucideIcon("calendar-x", __iconNode$lS);
  ...
  const Calendar = createLucideIcon("calendar", __iconNode$lR);
  ...
  const Calendars = createLucideIcon("calendars", __iconNode$lQ);
  ...
  const CameraOff = createLucideIcon("camera-off", __iconNode$lP);
  ...
  const Camera = createLucideIcon("camera", __iconNode$lO);
  ...
  const CandyOff = createLucideIcon("candy-off", __iconNode$lN);
  ...
  const CandyCane = createLucideIcon("candy-cane", __iconNode$lM);
  ...
  const Candy = createLucideIcon("candy", __iconNode$lL);
  ...
  const CannabisOff = createLucideIcon("cannabis-off", __iconNode$lK);
  ...
  const Cannabis = createLucideIcon("cannabis", __iconNode$lJ);
  ...
  const CaptionsOff = createLucideIcon("captions-off", __iconNode$lI);

  const __iconNode$lH = [
    ["rect", { width: "18", height: "14", x: "3", y: "5", rx: "2", ry: "2", key: "12ruh7" }],
    ["path", { d: "M7 15h4M15 15h2M7 11h2M13 11h4", key: "1ueiar" }]
  ];
  const Captions = createLucideIcon("captions", __iconNode$lH);
  ...
  const CarFront = createLucideIcon("car-front", __iconNode$lG);
  ...
  const Car = createLucideIcon("car", __iconNode$lF);
  ...
  const CarTaxiFront = createLucideIcon("car-taxi-front", __iconNode$lE);
  ...
  const CardSim = createLucideIcon("card-sim", __iconNode$lD);
  ...
  const Caravan = createLucideIcon("caravan", __iconNode$lC);
  ...
  const Carrot = createLucideIcon("carrot", __iconNode$lB);
  ...
  const CaseLower = createLucideIcon("case-lower", __iconNode$lA);
  ...
  const CaseSensitive = createLucideIcon("case-sensitive", __iconNode$lz);
  ...
  const CaseUpper = createLucideIcon("case-upper", __iconNode$ly);
  ...
  const CassetteTape = createLucideIcon("cassette-tape", __iconNode$lx);
  ...
  const Cast = createLucideIcon("cast", __iconNode$lw);
  ...
  const Castle = createLucideIcon("castle", __iconNode$lv);
  ...
  const Cat = createLucideIcon("cat", __iconNode$lu);
  ...
  const Cctv = createLucideIcon("cctv", __iconNode$lt);
  ...
  const ChartArea = createLucideIcon("chart-area", __iconNode$ls);
  ...
  const ChartBarBig = createLucideIcon("chart-bar-big", __iconNode$lr);
  ...
  const ChartBarDecreasing = createLucideIcon("chart-bar-decreasing", __iconNode$lq);
  ...
  const ChartBarIncreasing = createLucideIcon("chart-bar-increasing", __iconNode$lp);
  ...
  const ChartBarStacked = createLucideIcon("chart-bar-stacked", __iconNode$lo);
  ...
  const ChartBar = createLucideIcon("chart-bar", __iconNode$ln);
  ...
  const ChartCandlestick = createLucideIcon("chart-candlestick", __iconNode$lm);
  ...
  const ChartColumnBig = createLucideIcon("chart-column-big", __iconNode$ll);
  ...
  const ChartColumnDecreasing = createLucideIcon("chart-column-decreasing", __iconNode$lk);
  ...
  const ChartColumnIncreasing = createLucideIcon("chart-column-increasing", __iconNode$lj);
  ...
  const ChartColumnStacked = createLucideIcon("chart-column-stacked", __iconNode$li);
  ...
  const ChartColumn = createLucideIcon("chart-column", __iconNode$lh);
  ...
  const ChartGantt = createLucideIcon("chart-gantt", __iconNode$lg);

  const __iconNode$lf = [
    ["path", { d: "M3 3v16a2 2 0 0 0 2 2h16", key: "c24i48" }],
    ["path", { d: "m19 9-5 5-4-4-3 3", key: "2osh9i" }]
  ];
  const ChartLine = createLucideIcon("chart-line", __iconNode$lf);
  ...
  const ChartNetwork = createLucideIcon("chart-network", __iconNode$le);
  ...
  const ChartNoAxesColumnDecreasing = createLucideIcon("chart-no-axes-column-decreasing", __iconNode$ld);
  ...
  const ChartNoAxesColumnIncreasing = createLucideIcon("chart-no-axes-column-increasing", __iconNode$lc);
  ...
  const ChartNoAxesColumn = createLucideIcon("chart-no-axes-column", __iconNode$lb);
  ...
  const ChartNoAxesCombined = createLucideIcon("chart-no-axes-combined", __iconNode$la);
  ...
  const ChartNoAxesGantt = createLucideIcon("chart-no-axes-gantt", __iconNode$l9);
  ...
  const ChartPie = createLucideIcon("chart-pie", __iconNode$l8);
  ...
  const ChartScatter = createLucideIcon("chart-scatter", __iconNode$l7);

  const __iconNode$l6 = [
    ["path", { d: "M3 3v16a2 2 0 0 0 2 2h16", key: "c24i48" }],
    ["path", { d: "M7 16c.5-2 1.5-7 4-7 2 0 2 3 4 3 2.5 0 4.5-5 5-7", key: "lw07rv" }]
  ];
  const ChartSpline = createLucideIcon("chart-spline", __iconNode$l6);

  const __iconNode$l5 = [
    ["path", { d: "M18 6 7 17l-5-5", key: "116fxf" }],
    ["path", { d: "m22 10-7.5 7.5L13 16", key: "ke71qq" }]
  ];
  const CheckCheck = createLucideIcon("check-check", __iconNode$l5);
  ...
  const CheckLine = createLucideIcon("check-line", __iconNode$l4);

  const __iconNode$l3 = [["path", { d: "M20 6 9 17l-5-5", key: "1gmf2c" }]];
  const Check = createLucideIcon("check", __iconNode$l3);
  ...
  const ChefHat = createLucideIcon("chef-hat", __iconNode$l2);
  ...
  const Cherry = createLucideIcon("cherry", __iconNode$l1);
  ...
  const ChessBishop = createLucideIcon("chess-bishop", __iconNode$l0);
  ...
  const ChessKing = createLucideIcon("chess-king", __iconNode$k$);
  ...
  const ChessKnight = createLucideIcon("chess-knight", __iconNode$k_);
  ...
  const ChessPawn = createLucideIcon("chess-pawn", __iconNode$kZ);
  ...
  const ChessQueen = createLucideIcon("chess-queen", __iconNode$kY);
  ...
  const ChessRook = createLucideIcon("chess-rook", __iconNode$kX);

  const __iconNode$kW = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]];
  const ChevronDown = createLucideIcon("chevron-down", __iconNode$kW);

  const __iconNode$kV = [
    ["path", { d: "m17 18-6-6 6-6", key: "1yerx2" }],
    ["path", { d: "M7 6v12", key: "1p53r6" }]
  ];
  const ChevronFirst = createLucideIcon("chevron-first", __iconNode$kV);

  const __iconNode$kU = [
    ["path", { d: "m7 18 6-6-6-6", key: "lwmzdw" }],
    ["path", { d: "M17 6v12", key: "1o0aio" }]
  ];
  const ChevronLast = createLucideIcon("chevron-last", __iconNode$kU);

  const __iconNode$kT = [["path", { d: "m15 18-6-6 6-6", key: "1wnfg3" }]];
  const ChevronLeft = createLucideIcon("chevron-left", __iconNode$kT);

  const __iconNode$kS = [["path", { d: "m9 18 6-6-6-6", key: "mthhwq" }]];
  const ChevronRight = createLucideIcon("chevron-right", __iconNode$kS);

  const __iconNode$kR = [["path", { d: "m18 15-6-6-6 6", key: "153udz" }]];
  const ChevronUp = createLucideIcon("chevron-up", __iconNode$kR);

  const __iconNode$kQ = [
    ["path", { d: "m7 20 5-5 5 5", key: "13a0gw" }],
    ["path", { d: "m7 4 5 5 5-5", key: "1kwcof" }]
  ];
  const ChevronsDownUp = createLucideIcon("chevrons-down-up", __iconNode$kQ);

  const __iconNode$kP = [
    ["path", { d: "m7 6 5 5 5-5", key: "1lc07p" }],
    ["path", { d: "m7 13 5 5 5-5", key: "1d48rs" }]
  ];
  const ChevronsDown = createLucideIcon("chevrons-down", __iconNode$kP);
  ...
  const ChevronsLeftRightEllipsis = createLucideIcon("chevrons-left-right-ellipsis", __iconNode$kO);

  const __iconNode$kN = [
    ["path", { d: "m9 7-5 5 5 5", key: "j5w590" }],
    ["path", { d: "m15 7 5 5-5 5", key: "1bl6da" }]
  ];
  const ChevronsLeftRight = createLucideIcon("chevrons-left-right", __iconNode$kN);

  const __iconNode$kM = [
    ["path", { d: "m11 17-5-5 5-5", key: "13zhaf" }],
    ["path", { d: "m18 17-5-5 5-5", key: "h8a8et" }]
  ];
  const ChevronsLeft = createLucideIcon("chevrons-left", __iconNode$kM);

  const __iconNode$kL = [
    ["path", { d: "m20 17-5-5 5-5", key: "30x0n2" }],
    ["path", { d: "m4 17 5-5-5-5", key: "16spf4" }]
  ];
  const ChevronsRightLeft = createLucideIcon("chevrons-right-left", __iconNode$kL);

  const __iconNode$kK = [
    ["path", { d: "m6 17 5-5-5-5", key: "xnjwq" }],
    ["path", { d: "m13 17 5-5-5-5", key: "17xmmf" }]
  ];
  const ChevronsRight = createLucideIcon("chevrons-right", __iconNode$kK);

  const __iconNode$kJ = [
    ["path", { d: "m7 15 5 5 5-5", key: "1hf1tw" }],
    ["path", { d: "m7 9 5-5 5 5", key: "sgt6xg" }]
  ];
  const ChevronsUpDown = createLucideIcon("chevrons-up-down", __iconNode$kJ);

  const __iconNode$kI = [
    ["path", { d: "m17 11-5-5-5 5", key: "e8nh98" }],
    ["path", { d: "m17 18-5-5-5 5", key: "2avn1x" }]
  ];
  const ChevronsUp = createLucideIcon("chevrons-up", __iconNode$kI);
  ...
  const Chromium = createLucideIcon("chromium", __iconNode$kH);
  ...
  const Church = createLucideIcon("church", __iconNode$kG);
  ...
  const CigaretteOff = createLucideIcon("cigarette-off", __iconNode$kF);
  ...
  const Cigarette = createLucideIcon("cigarette", __iconNode$kE);
  ...
  const CircleAlert = createLucideIcon("circle-alert", __iconNode$kD);
  ...
  const CircleArrowDown = createLucideIcon("circle-arrow-down", __iconNode$kC);
  ...
  const CircleArrowLeft = createLucideIcon("circle-arrow-left", __iconNode$kB);
  ...
  const CircleArrowOutDownLeft = createLucideIcon("circle-arrow-out-down-left", __iconNode$kA);
  ...
  const CircleArrowOutDownRight = createLucideIcon("circle-arrow-out-down-right", __iconNode$kz);
  ...
  const CircleArrowOutUpLeft = createLucideIcon("circle-arrow-out-up-left", __iconNode$ky);
  ...
  const CircleArrowOutUpRight = createLucideIcon("circle-arrow-out-up-right", __iconNode$kx);
  ...
  const CircleArrowRight = createLucideIcon("circle-arrow-right", __iconNode$kw);
  ...
  const CircleArrowUp = createLucideIcon("circle-arrow-up", __iconNode$kv);

  const __iconNode$ku = [
    ["path", { d: "M21.801 10A10 10 0 1 1 17 3.335", key: "yps3ct" }],
    ["path", { d: "m9 11 3 3L22 4", key: "1pflzl" }]
  ];
  const CircleCheckBig = createLucideIcon("circle-check-big", __iconNode$ku);

  const __iconNode$kt = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m9 12 2 2 4-4", key: "dzmm74" }]
  ];
  const CircleCheck = createLucideIcon("circle-check", __iconNode$kt);

  const __iconNode$ks = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m16 10-4 4-4-4", key: "894hmk" }]
  ];
  const CircleChevronDown = createLucideIcon("circle-chevron-down", __iconNode$ks);

  const __iconNode$kr = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m14 16-4-4 4-4", key: "ojs7w8" }]
  ];
  const CircleChevronLeft = createLucideIcon("circle-chevron-left", __iconNode$kr);

  const __iconNode$kq = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m10 8 4 4-4 4", key: "1wy4r4" }]
  ];
  const CircleChevronRight = createLucideIcon("circle-chevron-right", __iconNode$kq);

  const __iconNode$kp = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m8 14 4-4 4 4", key: "fy2ptz" }]
  ];
  const CircleChevronUp = createLucideIcon("circle-chevron-up", __iconNode$kp);
  ...
  const CircleDashed = createLucideIcon("circle-dashed", __iconNode$ko);
  ...
  const CircleDollarSign = createLucideIcon("circle-dollar-sign", __iconNode$kn);
  ...
  const CircleDivide = createLucideIcon("circle-divide", __iconNode$km);
  ...
  const CircleDotDashed = createLucideIcon("circle-dot-dashed", __iconNode$kl);

  const __iconNode$kk = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["circle", { cx: "12", cy: "12", r: "1", key: "41hilf" }]
  ];
  const CircleDot = createLucideIcon("circle-dot", __iconNode$kk);
  ...
  const CircleEllipsis = createLucideIcon("circle-ellipsis", __iconNode$kj);
  ...
  const CircleEqual = createLucideIcon("circle-equal", __iconNode$ki);
  ...
  const CircleFadingArrowUp = createLucideIcon("circle-fading-arrow-up", __iconNode$kh);
  ...
  const CircleFadingPlus = createLucideIcon("circle-fading-plus", __iconNode$kg);
  ...
  const CircleGauge = createLucideIcon("circle-gauge", __iconNode$kf);

  const __iconNode$ke = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M8 12h8", key: "1wcyev" }]
  ];
  const CircleMinus = createLucideIcon("circle-minus", __iconNode$ke);
  ...
  const CircleOff = createLucideIcon("circle-off", __iconNode$kd);
  ...
  const CircleParkingOff = createLucideIcon("circle-parking-off", __iconNode$kc);

  const __iconNode$kb = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M9 17V7h4a3 3 0 0 1 0 6H9", key: "1dfk2c" }]
  ];
  const CircleParking = createLucideIcon("circle-parking", __iconNode$kb);
  ...
  const CirclePause = createLucideIcon("circle-pause", __iconNode$ka);
  ...
  const CirclePercent = createLucideIcon("circle-percent", __iconNode$k9);
  ...
  const CirclePile = createLucideIcon("circle-pile", __iconNode$k8);
  ...
  const CirclePlus = createLucideIcon("circle-plus", __iconNode$k7);
  ...
  const CirclePlay = createLucideIcon("circle-play", __iconNode$k6);
  ...
  const CirclePoundSterling = createLucideIcon("circle-pound-sterling", __iconNode$k5);
  ...
  const CirclePower = createLucideIcon("circle-power", __iconNode$k4);
  ...
  const CircleQuestionMark = createLucideIcon("circle-question-mark", __iconNode$k3);

  const __iconNode$k2 = [
    ["path", { d: "M22 2 2 22", key: "y4kqgn" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const CircleSlash2 = createLucideIcon("circle-slash-2", __iconNode$k2);

  const __iconNode$k1 = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["line", { x1: "9", x2: "15", y1: "15", y2: "9", key: "1dfufj" }]
  ];
  const CircleSlash = createLucideIcon("circle-slash", __iconNode$k1);
  ...
  const CircleStar = createLucideIcon("circle-star", __iconNode$k0);

  const __iconNode$j$ = [["circle", { cx: "12", cy: "12", r: "6", key: "1vlfrh" }]];
  const CircleSmall = createLucideIcon("circle-small", __iconNode$j$);

  const __iconNode$j_ = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["rect", { x: "9", y: "9", width: "6", height: "6", rx: "1", key: "1ssd4o" }]
  ];
  const CircleStop = createLucideIcon("circle-stop", __iconNode$j_);
  ...
  const CircleUserRound = createLucideIcon("circle-user-round", __iconNode$jZ);
  ...
  const CircleUser = createLucideIcon("circle-user", __iconNode$jY);
  ...
  const CircleX = createLucideIcon("circle-x", __iconNode$jX);

  const __iconNode$jW = [["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]];
  const Circle = createLucideIcon("circle", __iconNode$jW);
  ...
  const CircuitBoard = createLucideIcon("circuit-board", __iconNode$jV);
  ...
  const Citrus = createLucideIcon("citrus", __iconNode$jU);
  ...
  const Clapperboard = createLucideIcon("clapperboard", __iconNode$jT);
  ...
  const ClipboardCheck = createLucideIcon("clipboard-check", __iconNode$jS);
  ...
  const ClipboardClock = createLucideIcon("clipboard-clock", __iconNode$jR);
  ...
  const ClipboardCopy = createLucideIcon("clipboard-copy", __iconNode$jQ);
  ...
  const ClipboardList = createLucideIcon("clipboard-list", __iconNode$jP);
  ...
  const ClipboardMinus = createLucideIcon("clipboard-minus", __iconNode$jO);
  ...
  const ClipboardPaste = createLucideIcon("clipboard-paste", __iconNode$jN);
  ...
  const ClipboardPenLine = createLucideIcon("clipboard-pen-line", __iconNode$jM);
  ...
  const ClipboardPen = createLucideIcon("clipboard-pen", __iconNode$jL);
  ...
  const ClipboardPlus = createLucideIcon("clipboard-plus", __iconNode$jK);
  ...
  const ClipboardType = createLucideIcon("clipboard-type", __iconNode$jJ);
  ...
  const ClipboardX = createLucideIcon("clipboard-x", __iconNode$jI);
  ...
  const Clipboard = createLucideIcon("clipboard", __iconNode$jH);

  const __iconNode$jG = [
    ["path", { d: "M12 6v6l2-4", key: "miptyd" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock1 = createLucideIcon("clock-1", __iconNode$jG);

  const __iconNode$jF = [
    ["path", { d: "M12 6v6l-4-2", key: "cedpoo" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock10 = createLucideIcon("clock-10", __iconNode$jF);

  const __iconNode$jE = [
    ["path", { d: "M12 6v6l-2-4", key: "ns39ag" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock11 = createLucideIcon("clock-11", __iconNode$jE);

  const __iconNode$jD = [
    ["path", { d: "M12 6v6", key: "1ipuwl" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock12 = createLucideIcon("clock-12", __iconNode$jD);

  const __iconNode$jC = [
    ["path", { d: "M12 6v6l4-2", key: "1r2kuh" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock2 = createLucideIcon("clock-2", __iconNode$jC);

  const __iconNode$jB = [
    ["path", { d: "M12 6v6h4", key: "135r8i" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock3 = createLucideIcon("clock-3", __iconNode$jB);

  const __iconNode$jA = [
    ["path", { d: "M12 6v6l4 2", key: "mmk7yg" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock4 = createLucideIcon("clock-4", __iconNode$jA);

  const __iconNode$jz = [
    ["path", { d: "M12 6v6l2 4", key: "1287s9" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock5 = createLucideIcon("clock-5", __iconNode$jz);

  const __iconNode$jy = [
    ["path", { d: "M12 6v10", key: "wf7rdh" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock6 = createLucideIcon("clock-6", __iconNode$jy);

  const __iconNode$jx = [
    ["path", { d: "M12 6v6l-2 4", key: "1095bu" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock7 = createLucideIcon("clock-7", __iconNode$jx);

  const __iconNode$jw = [
    ["path", { d: "M12 6v6l-4 2", key: "imc3wl" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock8 = createLucideIcon("clock-8", __iconNode$jw);

  const __iconNode$jv = [
    ["path", { d: "M12 6v6H8", key: "u39vzm" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock9 = createLucideIcon("clock-9", __iconNode$jv);
  ...
  const ClockAlert = createLucideIcon("clock-alert", __iconNode$ju);
  ...
  const ClockArrowDown = createLucideIcon("clock-arrow-down", __iconNode$jt);
  ...
  const ClockArrowUp = createLucideIcon("clock-arrow-up", __iconNode$js);
  ...
  const ClockCheck = createLucideIcon("clock-check", __iconNode$jr);
  ...
  const ClockFading = createLucideIcon("clock-fading", __iconNode$jq);
  ...
  const ClockPlus = createLucideIcon("clock-plus", __iconNode$jp);

  const __iconNode$jo = [
    ["path", { d: "M12 6v6l4 2", key: "mmk7yg" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock = createLucideIcon("clock", __iconNode$jo);
  ...
  const ClosedCaption = createLucideIcon("closed-caption", __iconNode$jn);
  ...
  const CloudAlert = createLucideIcon("cloud-alert", __iconNode$jm);
  ...
  const CloudBackup = createLucideIcon("cloud-backup", __iconNode$jl);

  const __iconNode$jk = [
    ["path", { d: "m17 15-5.5 5.5L9 18", key: "15q87x" }],
    ["path", { d: "M5 17.743A7 7 0 1 1 15.71 10h1.79a4.5 4.5 0 0 1 1.5 8.742", key: "9ho6ki" }]
  ];
  const CloudCheck = createLucideIcon("cloud-check", __iconNode$jk);
  ...
  const CloudCog = createLucideIcon("cloud-cog", __iconNode$jj);
  ...
  const CloudDrizzle = createLucideIcon("cloud-drizzle", __iconNode$ji);
  ...
  const CloudDownload = createLucideIcon("cloud-download", __iconNode$jh);
  ...
  const CloudFog = createLucideIcon("cloud-fog", __iconNode$jg);
  ...
  const CloudHail = createLucideIcon("cloud-hail", __iconNode$jf);

  const __iconNode$je = [
    ["path", { d: "M6 16.326A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 .5 8.973", key: "1cez44" }],
    ["path", { d: "m13 12-3 5h4l-3 5", key: "1t22er" }]
  ];
  const CloudLightning = createLucideIcon("cloud-lightning", __iconNode$je);
  ...
  const CloudMoonRain = createLucideIcon("cloud-moon-rain", __iconNode$jd);
  ...
  const CloudMoon = createLucideIcon("cloud-moon", __iconNode$jc);
  ...
  const CloudOff = createLucideIcon("cloud-off", __iconNode$jb);
  ...
  const CloudRainWind = createLucideIcon("cloud-rain-wind", __iconNode$ja);
  ...
  const CloudRain = createLucideIcon("cloud-rain", __iconNode$j9);
  ...
  const CloudSnow = createLucideIcon("cloud-snow", __iconNode$j8);
  ...
  const CloudSunRain = createLucideIcon("cloud-sun-rain", __iconNode$j7);
  ...
  const CloudSun = createLucideIcon("cloud-sun", __iconNode$j6);
  ...
  const CloudSync = createLucideIcon("cloud-sync", __iconNode$j5);
  ...
  const CloudUpload = createLucideIcon("cloud-upload", __iconNode$j4);

  const __iconNode$j3 = [
    ["path", { d: "M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z", key: "p7xjir" }]
  ];
  const Cloud = createLucideIcon("cloud", __iconNode$j3);
  ...
  const Clover = createLucideIcon("clover", __iconNode$j2);
  ...
  const Cloudy = createLucideIcon("cloudy", __iconNode$j1);
  ...
  const Club = createLucideIcon("club", __iconNode$j0);
  ...
  const Code = createLucideIcon("code", __iconNode$i_);
  ...
  const Codepen = createLucideIcon("codepen", __iconNode$iZ);
  ...
  const Codesandbox = createLucideIcon("codesandbox", __iconNode$iY);
  ...
  const Coffee = createLucideIcon("coffee", __iconNode$iX);
  ...
  const Cog = createLucideIcon("cog", __iconNode$iW);
  ...
  const Coins = createLucideIcon("coins", __iconNode$iV);

  const __iconNode$iU = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "M12 3v18", key: "108xh3" }]
  ];
  const Columns2 = createLucideIcon("columns-2", __iconNode$iU);
  ...
  const Columns3Cog = createLucideIcon("columns-3-cog", __iconNode$iT);
  ...
  const Columns3 = createLucideIcon("columns-3", __iconNode$iS);
  ...
  const Columns4 = createLucideIcon("columns-4", __iconNode$iR);
  ...
  const Combine = createLucideIcon("combine", __iconNode$iQ);
  ...
  const Command = createLucideIcon("command", __iconNode$iP);
  ...
  const Compass = createLucideIcon("compass", __iconNode$iO);
  ...
  const Component = createLucideIcon("component", __iconNode$iN);
  ...
  const Computer = createLucideIcon("computer", __iconNode$iM);
  ...
  const ConciergeBell = createLucideIcon("concierge-bell", __iconNode$iL);

  const __iconNode$iK = [
    ["path", { d: "m20.9 18.55-8-15.98a1 1 0 0 0-1.8 0l-8 15.98", key: "53pte7" }],
    ["ellipse", { cx: "12", cy: "19", rx: "9", ry: "3", key: "1ji25f" }]
  ];
  const Cone = createLucideIcon("cone", __iconNode$iK);
  ...
  const Construction = createLucideIcon("construction", __iconNode$iJ);
  ...
  const ContactRound = createLucideIcon("contact-round", __iconNode$iI);
  ...
  const Contact = createLucideIcon("contact", __iconNode$iH);
  ...
  const Container = createLucideIcon("container", __iconNode$iG);

  const __iconNode$iF = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M12 18a6 6 0 0 0 0-12v12z", key: "j4l70d" }]
  ];
  const Contrast = createLucideIcon("contrast", __iconNode$iF);
  ...
  const Cookie = createLucideIcon("cookie", __iconNode$iE);
  ...
  const CookingPot = createLucideIcon("cooking-pot", __iconNode$iD);
  ...
  const CopyCheck = createLucideIcon("copy-check", __iconNode$iC);
  ...
  const CopyMinus = createLucideIcon("copy-minus", __iconNode$iB);
  ...
  const CopyPlus = createLucideIcon("copy-plus", __iconNode$iA);
  ...
  const CopySlash = createLucideIcon("copy-slash", __iconNode$iz);
  ...
  const CopyX = createLucideIcon("copy-x", __iconNode$iy);

  const __iconNode$ix = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M9.17 14.83a4 4 0 1 0 0-5.66", key: "1sveal" }]
  ];
  const Copyleft = createLucideIcon("copyleft", __iconNode$ix);

  const __iconNode$iw = [
    ["rect", { width: "14", height: "14", x: "8", y: "8", rx: "2", ry: "2", key: "17jyea" }],
    ["path", { d: "M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2", key: "zix9uf" }]
  ];
  const Copy = createLucideIcon("copy", __iconNode$iw);

  const __iconNode$iv = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M14.83 14.83a4 4 0 1 1 0-5.66", key: "1i56pz" }]
  ];
  const Copyright = createLucideIcon("copyright", __iconNode$iv);

  const __iconNode$iu = [
    ["path", { d: "M20 4v7a4 4 0 0 1-4 4H4", key: "6o5b7l" }],
    ["path", { d: "m9 10-5 5 5 5", key: "1kshq7" }]
  ];
  const CornerDownLeft = createLucideIcon("corner-down-left", __iconNode$iu);

  const __iconNode$it = [
    ["path", { d: "m15 10 5 5-5 5", key: "qqa56n" }],
    ["path", { d: "M4 4v7a4 4 0 0 0 4 4h12", key: "z08zvw" }]
  ];
  const CornerDownRight = createLucideIcon("corner-down-right", __iconNode$it);

  const __iconNode$is = [
    ["path", { d: "m14 15-5 5-5-5", key: "1eia93" }],
    ["path", { d: "M20 4h-7a4 4 0 0 0-4 4v12", key: "nbpdq2" }]
  ];
  const CornerLeftDown = createLucideIcon("corner-left-down", __iconNode$is);

  const __iconNode$ir = [
    ["path", { d: "M14 9 9 4 4 9", key: "1af5af" }],
    ["path", { d: "M20 20h-7a4 4 0 0 1-4-4V4", key: "1blwi3" }]
  ];
  const CornerLeftUp = createLucideIcon("corner-left-up", __iconNode$ir);

  const __iconNode$iq = [
    ["path", { d: "m10 15 5 5 5-5", key: "1hpjnr" }],
    ["path", { d: "M4 4h7a4 4 0 0 1 4 4v12", key: "wcbgct" }]
  ];
  const CornerRightDown = createLucideIcon("corner-right-down", __iconNode$iq);

  const __iconNode$ip = [
    ["path", { d: "m10 9 5-5 5 5", key: "9ctzwi" }],
    ["path", { d: "M4 20h7a4 4 0 0 0 4-4V4", key: "1plgdj" }]
  ];
  const CornerRightUp = createLucideIcon("corner-right-up", __iconNode$ip);

  const __iconNode$io = [
    ["path", { d: "M20 20v-7a4 4 0 0 0-4-4H4", key: "1nkjon" }],
    ["path", { d: "M9 14 4 9l5-5", key: "102s5s" }]
  ];
  const CornerUpLeft = createLucideIcon("corner-up-left", __iconNode$io);

  const __iconNode$in = [
    ["path", { d: "m15 14 5-5-5-5", key: "12vg1m" }],
    ["path", { d: "M4 20v-7a4 4 0 0 1 4-4h12", key: "1lu4f8" }]
  ];
  const CornerUpRight = createLucideIcon("corner-up-right", __iconNode$in);
  ...
  const Cpu = createLucideIcon("cpu", __iconNode$im);
  ...
  const CreativeCommons = createLucideIcon("creative-commons", __iconNode$il);

  const __iconNode$ik = [
    ["rect", { width: "20", height: "14", x: "2", y: "5", rx: "2", key: "ynyp8z" }],
    ["line", { x1: "2", x2: "22", y1: "10", y2: "10", key: "1b3vmo" }]
  ];
  const CreditCard = createLucideIcon("credit-card", __iconNode$ik);
  ...
  const Croissant = createLucideIcon("croissant", __iconNode$ij);

  const __iconNode$ii = [
    ["path", { d: "M6 2v14a2 2 0 0 0 2 2h14", key: "ron5a4" }],
    ["path", { d: "M18 22V8a2 2 0 0 0-2-2H2", key: "7s9ehn" }]
  ];
  const Crop = createLucideIcon("crop", __iconNode$ii);
  ...
  const Cross = createLucideIcon("cross", __iconNode$ih);
  ...
  const Crown = createLucideIcon("crown", __iconNode$ig);
  ...
  const Crosshair = createLucideIcon("crosshair", __iconNode$if);
  ...
  const Cuboid = createLucideIcon("cuboid", __iconNode$ie);
  ...
  const CupSoda = createLucideIcon("cup-soda", __iconNode$id);
  ...
  const Currency = createLucideIcon("currency", __iconNode$ic);

  const __iconNode$ib = [
    ["ellipse", { cx: "12", cy: "5", rx: "9", ry: "3", key: "msslwz" }],
    ["path", { d: "M3 5v14a9 3 0 0 0 18 0V5", key: "aqi0yr" }]
  ];
  const Cylinder = createLucideIcon("cylinder", __iconNode$ib);
  ...
  const Dam = createLucideIcon("dam", __iconNode$ia);
  ...
  const DatabaseBackup = createLucideIcon("database-backup", __iconNode$i9);
  ...
  const DatabaseZap = createLucideIcon("database-zap", __iconNode$i8);
  ...
  const Database = createLucideIcon("database", __iconNode$i7);
  ...
  const DecimalsArrowLeft = createLucideIcon("decimals-arrow-left", __iconNode$i6);
  ...
  const DecimalsArrowRight = createLucideIcon("decimals-arrow-right", __iconNode$i5);
  ...
  const Delete = createLucideIcon("delete", __iconNode$i4);
  ...
  const Dessert = createLucideIcon("dessert", __iconNode$i3);
  ...
  const Diameter = createLucideIcon("diameter", __iconNode$i2);
  ...
  const DiamondMinus = createLucideIcon("diamond-minus", __iconNode$i1);
  ...
  const DiamondPercent = createLucideIcon("diamond-percent", __iconNode$i0);
  ...
  const DiamondPlus = createLucideIcon("diamond-plus", __iconNode$h$);
  ...
  const Diamond = createLucideIcon("diamond", __iconNode$h_);

  const __iconNode$hZ = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", ry: "2", key: "1m3agn" }],
    ["path", { d: "M12 12h.01", key: "1mp3jc" }]
  ];
  const Dice1 = createLucideIcon("dice-1", __iconNode$hZ);
  ...
  const Dice2 = createLucideIcon("dice-2", __iconNode$hY);
  ...
  const Dice3 = createLucideIcon("dice-3", __iconNode$hX);
  ...
  const Dice4 = createLucideIcon("dice-4", __iconNode$hW);
  ...
  const Dice5 = createLucideIcon("dice-5", __iconNode$hV);
  ...
  const Dices = createLucideIcon("dices", __iconNode$hT);
  ...
  const Diff = createLucideIcon("diff", __iconNode$hS);
  ...
  const Disc2 = createLucideIcon("disc-2", __iconNode$hR);
  ...
  const Disc3 = createLucideIcon("disc-3", __iconNode$hQ);
  ...
  const DiscAlbum = createLucideIcon("disc-album", __iconNode$hP);
  ...
  const DnaOff = createLucideIcon("dna-off", __iconNode$hM);
  ...
  const Dna = createLucideIcon("dna", __iconNode$hL);
  ...
  const Dock = createLucideIcon("dock", __iconNode$hK);
  ...
  const Dog = createLucideIcon("dog", __iconNode$hJ);

  const __iconNode$hI = [
    ["line", { x1: "12", x2: "12", y1: "2", y2: "22", key: "7eqyqh" }],
    ["path", { d: "M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6", key: "1b0p4s" }]
  ];
  const DollarSign = createLucideIcon("dollar-sign", __iconNode$hI);
  ...
  const Donut = createLucideIcon("donut", __iconNode$hH);
  ...
  const DoorClosedLocked = createLucideIcon("door-closed-locked", __iconNode$hG);
  ...
  const DoorClosed = createLucideIcon("door-closed", __iconNode$hF);
  ...
  const DoorOpen = createLucideIcon("door-open", __iconNode$hE);

  const __iconNode$hD = [["circle", { cx: "12.1", cy: "12.1", r: "1", key: "18d7e5" }]];
  const Dot = createLucideIcon("dot", __iconNode$hD);
  ...
  const Download = createLucideIcon("download", __iconNode$hC);
  ...
  const DraftingCompass = createLucideIcon("drafting-compass", __iconNode$hB);
  ...
  const Drama = createLucideIcon("drama", __iconNode$hA);
  ...
  const Drill = createLucideIcon("drill", __iconNode$hz);
  ...
  const Dribbble = createLucideIcon("dribbble", __iconNode$hy);
  ...
  const Drone = createLucideIcon("drone", __iconNode$hx);
  ...
  const DropletOff = createLucideIcon("droplet-off", __iconNode$hw);
  ...
  const Droplet = createLucideIcon("droplet", __iconNode$hv);
  ...
  const Droplets = createLucideIcon("droplets", __iconNode$hu);
  ...
  const Drum = createLucideIcon("drum", __iconNode$ht);
  ...
  const Drumstick = createLucideIcon("drumstick", __iconNode$hs);
  ...
  const Dumbbell = createLucideIcon("dumbbell", __iconNode$hr);

  const __iconNode$hq = [
    ["path", { d: "M6 8.5a6.5 6.5 0 1 1 13 0c0 6-6 6-6 10a3.5 3.5 0 1 1-7 0", key: "1dfaln" }],
    ["path", { d: "M15 8.5a2.5 2.5 0 0 0-5 0v1a2 2 0 1 1 0 4", key: "1qnva7" }]
  ];
  const Ear = createLucideIcon("ear", __iconNode$hq);
  ...
  const EarOff = createLucideIcon("ear-off", __iconNode$hp);
  ...
  const EarthLock = createLucideIcon("earth-lock", __iconNode$ho);
  ...
  const Earth = createLucideIcon("earth", __iconNode$hn);

  const __iconNode$hm = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M12 2a7 7 0 1 0 10 10", key: "1yuj32" }]
  ];
  const Eclipse = createLucideIcon("eclipse", __iconNode$hm);
  ...
  const EggFried = createLucideIcon("egg-fried", __iconNode$hl);
  ...
  const EggOff = createLucideIcon("egg-off", __iconNode$hk);

  const __iconNode$hj = [
    ["path", { d: "M12 2C8 2 4 8 4 14a8 8 0 0 0 16 0c0-6-4-12-8-12", key: "1le142" }]
  ];
  const Egg = createLucideIcon("egg", __iconNode$hj);
  ...
  const EllipsisVertical = createLucideIcon("ellipsis-vertical", __iconNode$hi);
  ...
  const Ellipsis = createLucideIcon("ellipsis", __iconNode$hh);

  const __iconNode$hg = [
    ["path", { d: "M5 15a6.5 6.5 0 0 1 7 0 6.5 6.5 0 0 0 7 0", key: "yrdkhy" }],
    ["path", { d: "M5 9a6.5 6.5 0 0 1 7 0 6.5 6.5 0 0 0 7 0", key: "gzkvyz" }]
  ];
  const EqualApproximately = createLucideIcon("equal-approximately", __iconNode$hg);
  ...
  const EqualNot = createLucideIcon("equal-not", __iconNode$hf);

  const __iconNode$he = [
    ["line", { x1: "5", x2: "19", y1: "9", y2: "9", key: "1nwqeh" }],
    ["line", { x1: "5", x2: "19", y1: "15", y2: "15", key: "g8yjpy" }]
  ];
  const Equal = createLucideIcon("equal", __iconNode$he);
  ...
  const Eraser = createLucideIcon("eraser", __iconNode$hd);
  ...
  const EthernetPort = createLucideIcon("ethernet-port", __iconNode$hc);
  ...
  const Euro = createLucideIcon("euro", __iconNode$hb);
  ...
  const EvCharger = createLucideIcon("ev-charger", __iconNode$ha);
  ...
  const Expand = createLucideIcon("expand", __iconNode$h9);
  ...
  const ExternalLink = createLucideIcon("external-link", __iconNode$h8);
  ...
  const EyeClosed = createLucideIcon("eye-closed", __iconNode$h7);
  ...
  const EyeOff = createLucideIcon("eye-off", __iconNode$h6);
  ...
  const Eye = createLucideIcon("eye", __iconNode$h5);
  ...
  const Facebook = createLucideIcon("facebook", __iconNode$h4);
  ...
  const Factory = createLucideIcon("factory", __iconNode$h3);
  ...
  const Fan = createLucideIcon("fan", __iconNode$h2);
  ...
  const FastForward = createLucideIcon("fast-forward", __iconNode$h1);
  ...
  const Feather = createLucideIcon("feather", __iconNode$h0);
  ...
  const Fence = createLucideIcon("fence", __iconNode$g$);
  ...
  const FerrisWheel = createLucideIcon("ferris-wheel", __iconNode$g_);
  ...
  const FileAxis3d = createLucideIcon("file-axis-3d", __iconNode$gX);
  ...
  const FileBadge = createLucideIcon("file-badge", __iconNode$gW);
  ...
  const FileBox = createLucideIcon("file-box", __iconNode$gV);
  ...
  const FileBracesCorner = createLucideIcon("file-braces-corner", __iconNode$gU);
  ...
  const FileBraces = createLucideIcon("file-braces", __iconNode$gT);
  ...
  const FileChartColumn = createLucideIcon("file-chart-column", __iconNode$gS);
  ...
  const FileChartLine = createLucideIcon("file-chart-line", __iconNode$gQ);
  ...
  const FileChartPie = createLucideIcon("file-chart-pie", __iconNode$gP);
  ...
  const FileCheckCorner = createLucideIcon("file-check-corner", __iconNode$gO);
  ...
  const FileCheck = createLucideIcon("file-check", __iconNode$gN);
  ...
  const FileClock = createLucideIcon("file-clock", __iconNode$gM);
  ...
  const FileCodeCorner = createLucideIcon("file-code-corner", __iconNode$gL);
  ...
  const FileCode = createLucideIcon("file-code", __iconNode$gK);
  ...
  const FileCog = createLucideIcon("file-cog", __iconNode$gJ);
  ...
  const FileDigit = createLucideIcon("file-digit", __iconNode$gI);
  ...
  const FileDown = createLucideIcon("file-down", __iconNode$gH);
  ...
  const FileExclamationPoint = createLucideIcon("file-exclamation-point", __iconNode$gF);
  ...
  const FileHeadphone = createLucideIcon("file-headphone", __iconNode$gE);
  ...
  const FileHeart = createLucideIcon("file-heart", __iconNode$gD);
  ...
  const FileImage = createLucideIcon("file-image", __iconNode$gC);
  ...
  const FileInput = createLucideIcon("file-input", __iconNode$gB);
  ...
  const FileKey = createLucideIcon("file-key", __iconNode$gA);
  ...
  const FileLock = createLucideIcon("file-lock", __iconNode$gz);
  ...
  const FileMinusCorner = createLucideIcon("file-minus-corner", __iconNode$gy);
  ...
  const FileMinus = createLucideIcon("file-minus", __iconNode$gx);
  ...
  const FileMusic = createLucideIcon("file-music", __iconNode$gw);
  ...
  const FileOutput = createLucideIcon("file-output", __iconNode$gv);
  ...
  const FilePenLine = createLucideIcon("file-pen-line", __iconNode$gu);
  ...
  const FilePen = createLucideIcon("file-pen", __iconNode$gt);
  ...
  const FilePlay = createLucideIcon("file-play", __iconNode$gs);
  ...
  const FilePlusCorner = createLucideIcon("file-plus-corner", __iconNode$gr);
  ...
  const FilePlus = createLucideIcon("file-plus", __iconNode$gq);
  ...
  const FileQuestionMark = createLucideIcon("file-question-mark", __iconNode$gp);
  ...
  const FileScan = createLucideIcon("file-scan", __iconNode$go);
  ...
  const FileSearchCorner = createLucideIcon("file-search-corner", __iconNode$gn);
  ...
  const FileSearch = createLucideIcon("file-search", __iconNode$gm);
  ...
  const FileSignal = createLucideIcon("file-signal", __iconNode$gl);
  ...
  const FileSliders = createLucideIcon("file-sliders", __iconNode$gk);
  ...
  const FileSpreadsheet = createLucideIcon("file-spreadsheet", __iconNode$gj);
  ...
  const FileStack = createLucideIcon("file-stack", __iconNode$gi);
  ...
  const FileSymlink = createLucideIcon("file-symlink", __iconNode$gh);
  ...
  const FileTerminal = createLucideIcon("file-terminal", __iconNode$gg);
  ...
  const FileText = createLucideIcon("file-text", __iconNode$gf);
  ...
  const FileTypeCorner = createLucideIcon("file-type-corner", __iconNode$ge);
  ...
  const FileType = createLucideIcon("file-type", __iconNode$gd);
  ...
  const FileUp = createLucideIcon("file-up", __iconNode$gc);
  ...
  const FileUser = createLucideIcon("file-user", __iconNode$gb);
  ...
  const FileVolume = createLucideIcon("file-volume", __iconNode$ga);
  ...
  const FileVideoCamera = createLucideIcon("file-video-camera", __iconNode$g9);
  ...
  const FileXCorner = createLucideIcon("file-x-corner", __iconNode$g8);
  ...
  const FileX = createLucideIcon("file-x", __iconNode$g7);
  ...
  const File = createLucideIcon("file", __iconNode$g6);
  ...
  const Files = createLucideIcon("files", __iconNode$g5);
  ...
  const Film = createLucideIcon("film", __iconNode$g4);
  ...
  const FingerprintPattern = createLucideIcon("fingerprint-pattern", __iconNode$g3);
  ...
  const FireExtinguisher = createLucideIcon("fire-extinguisher", __iconNode$g2);
  ...
  const FishOff = createLucideIcon("fish-off", __iconNode$g1);

  const __iconNode$g0 = [
    ["path", { d: "M2 16s9-15 20-4C11 23 2 8 2 8", key: "h4oh4o" }]
  ];
  const FishSymbol = createLucideIcon("fish-symbol", __iconNode$g0);
  ...
  const Fish = createLucideIcon("fish", __iconNode$f$);
  ...
  const FishingHook = createLucideIcon("fishing-hook", __iconNode$f_);
  ...
  const FlagOff = createLucideIcon("flag-off", __iconNode$fZ);
  ...
  const FlagTriangleLeft = createLucideIcon("flag-triangle-left", __iconNode$fY);
  ...
  const FlagTriangleRight = createLucideIcon("flag-triangle-right", __iconNode$fX);
  ...
  const Flag = createLucideIcon("flag", __iconNode$fW);
  ...
  const FlameKindling = createLucideIcon("flame-kindling", __iconNode$fV);
  ...
  const Flame = createLucideIcon("flame", __iconNode$fU);
  ...
  const FlashlightOff = createLucideIcon("flashlight-off", __iconNode$fT);
  ...
  const Flashlight = createLucideIcon("flashlight", __iconNode$fS);
  ...
  const FlaskConicalOff = createLucideIcon("flask-conical-off", __iconNode$fR);
  ...
  const FlaskConical = createLucideIcon("flask-conical", __iconNode$fQ);
  ...
  const FlaskRound = createLucideIcon("flask-round", __iconNode$fP);
  ...
  const FlipHorizontal2 = createLucideIcon("flip-horizontal-2", __iconNode$fO);
  ...
  const FlipHorizontal = createLucideIcon("flip-horizontal", __iconNode$fN);
  ...
  const FlipVertical2 = createLucideIcon("flip-vertical-2", __iconNode$fM);
  ...
  const FlipVertical = createLucideIcon("flip-vertical", __iconNode$fL);
  ...
  const Flower2 = createLucideIcon("flower-2", __iconNode$fK);
  ...
  const Flower = createLucideIcon("flower", __iconNode$fJ);
  ...
  const Focus = createLucideIcon("focus", __iconNode$fI);
  ...
  const FoldVertical = createLucideIcon("fold-vertical", __iconNode$fH);
  ...
  const FoldHorizontal = createLucideIcon("fold-horizontal", __iconNode$fG);
  ...
  const FolderArchive = createLucideIcon("folder-archive", __iconNode$fF);
  ...
  const FolderCheck = createLucideIcon("folder-check", __iconNode$fE);
  ...
  const FolderClock = createLucideIcon("folder-clock", __iconNode$fD);
  ...
  const FolderClosed = createLucideIcon("folder-closed", __iconNode$fC);
  ...
  const FolderCode = createLucideIcon("folder-code", __iconNode$fB);
  ...
  const FolderDot = createLucideIcon("folder-dot", __iconNode$fA);
  ...
  const FolderCog = createLucideIcon("folder-cog", __iconNode$fz);
  ...
  const FolderDown = createLucideIcon("folder-down", __iconNode$fy);
  ...
  const FolderGit2 = createLucideIcon("folder-git-2", __iconNode$fx);
  ...
  const FolderGit = createLucideIcon("folder-git", __iconNode$fw);
  ...
  const FolderHeart = createLucideIcon("folder-heart", __iconNode$fv);
  ...
  const FolderInput = createLucideIcon("folder-input", __iconNode$fu);
  ...
  const FolderKey = createLucideIcon("folder-key", __iconNode$ft);
  ...
  const FolderKanban = createLucideIcon("folder-kanban", __iconNode$fs);
  ...
  const FolderLock = createLucideIcon("folder-lock", __iconNode$fr);
  ...
  const FolderMinus = createLucideIcon("folder-minus", __iconNode$fq);
  ...
  const FolderOpenDot = createLucideIcon("folder-open-dot", __iconNode$fp);
  ...
  const FolderOpen = createLucideIcon("folder-open", __iconNode$fo);
  ...
  const FolderOutput = createLucideIcon("folder-output", __iconNode$fn);
  ...
  const FolderPen = createLucideIcon("folder-pen", __iconNode$fm);
  ...
  const FolderPlus = createLucideIcon("folder-plus", __iconNode$fl);
  ...
  const FolderRoot = createLucideIcon("folder-root", __iconNode$fk);
  ...
  const FolderSearch2 = createLucideIcon("folder-search-2", __iconNode$fj);
  ...
  const FolderSearch = createLucideIcon("folder-search", __iconNode$fi);
  ...
  const FolderSymlink = createLucideIcon("folder-symlink", __iconNode$fh);
  ...
  const FolderSync = createLucideIcon("folder-sync", __iconNode$fg);
  ...
  const FolderTree = createLucideIcon("folder-tree", __iconNode$ff);
  ...
  const FolderUp = createLucideIcon("folder-up", __iconNode$fe);
  ...
  const Folder = createLucideIcon("folder", __iconNode$fd);
  ...
  const Folders = createLucideIcon("folders", __iconNode$fc);
  ...
  const Footprints = createLucideIcon("footprints", __iconNode$fa);
  ...
  const Forklift = createLucideIcon("forklift", __iconNode$f9);
  ...
  const Form = createLucideIcon("form", __iconNode$f8);

  const __iconNode$f7 = [
    ["path", { d: "m15 17 5-5-5-5", key: "nf172w" }],
    ["path", { d: "M4 18v-2a4 4 0 0 1 4-4h12", key: "jmiej9" }]
  ];
  const Forward = createLucideIcon("forward", __iconNode$f7);
  ...
  const Frame = createLucideIcon("frame", __iconNode$f6);

  const __iconNode$f5 = [
    ["path", { d: "M5 16V9h14V2H5l14 14h-7m-7 0 7 7v-7m-7 0h7", key: "1a2nng" }]
  ];
  const Framer = createLucideIcon("framer", __iconNode$f5);
  ...
  const Frown = createLucideIcon("frown", __iconNode$f4);
  ...
  const Fuel = createLucideIcon("fuel", __iconNode$f3);
  ...
  const Fullscreen = createLucideIcon("fullscreen", __iconNode$f2);
  ...
  const FunnelPlus = createLucideIcon("funnel-plus", __iconNode$f1);
  ...
  const FunnelX = createLucideIcon("funnel-x", __iconNode$f0);
  ...
  const GalleryHorizontalEnd = createLucideIcon("gallery-horizontal-end", __iconNode$e$);
  ...
  const Funnel = createLucideIcon("funnel", __iconNode$e_);
  ...
  const GalleryHorizontal = createLucideIcon("gallery-horizontal", __iconNode$eZ);
  ...
  const GalleryThumbnails = createLucideIcon("gallery-thumbnails", __iconNode$eY);
  ...
  const GalleryVerticalEnd = createLucideIcon("gallery-vertical-end", __iconNode$eX);
  ...
  const GalleryVertical = createLucideIcon("gallery-vertical", __iconNode$eW);
  ...
  const Gamepad2 = createLucideIcon("gamepad-2", __iconNode$eV);
  ...
  const GamepadDirectional = createLucideIcon("gamepad-directional", __iconNode$eU);
  ...
  const Gamepad = createLucideIcon("gamepad", __iconNode$eT);

  const __iconNode$eS = [
    ["path", { d: "m12 14 4-4", key: "9kzdfg" }],
    ["path", { d: "M3.34 19a10 10 0 1 1 17.32 0", key: "19p75a" }]
  ];
  const Gauge = createLucideIcon("gauge", __iconNode$eS);
  ...
  const Gem = createLucideIcon("gem", __iconNode$eR);
  ...
  const Ghost = createLucideIcon("ghost", __iconNode$eP);
  ...
  const Gift = createLucideIcon("gift", __iconNode$eN);
  ...
  const GitBranchMinus = createLucideIcon("git-branch-minus", __iconNode$eM);
  ...
  const GitCompareArrows = createLucideIcon("git-compare-arrows", __iconNode$eH);
  ...
  const GitCompare = createLucideIcon("git-compare", __iconNode$eG);
  ...
  const GitPullRequestCreate = createLucideIcon("git-pull-request-create", __iconNode$ez);
  ...
  const GitPullRequestDraft = createLucideIcon("git-pull-request-draft", __iconNode$ey);
  ...
  const GitPullRequest = createLucideIcon("git-pull-request", __iconNode$ex);
  ...
  const Github = createLucideIcon("github", __iconNode$ew);
  ...
  const Gitlab = createLucideIcon("gitlab", __iconNode$ev);
  ...
  const GlassWater = createLucideIcon("glass-water", __iconNode$eu);
  ...
  const Glasses = createLucideIcon("glasses", __iconNode$et);
  ...
  const GlobeLock = createLucideIcon("globe-lock", __iconNode$es);
  ...
  const GlobeX = createLucideIcon("globe-x", __iconNode$er);
  ...
  const Globe = createLucideIcon("globe", __iconNode$eq);
  ...
  const Gpu = createLucideIcon("gpu", __iconNode$ep);
  ...
  const GraduationCap = createLucideIcon("graduation-cap", __iconNode$en);
  ...
  const Grape = createLucideIcon("grape", __iconNode$em);
  ...
  const Grid2x2Check = createLucideIcon("grid-2x2-check", __iconNode$el);
  ...
  const Grid2x2Plus = createLucideIcon("grid-2x2-plus", __iconNode$ek);
  ...
  const Grid2x2X = createLucideIcon("grid-2x2-x", __iconNode$ej);
  ...
  const Grid2x2 = createLucideIcon("grid-2x2", __iconNode$ei);
  ...
  const Grid3x2 = createLucideIcon("grid-3x2", __iconNode$eh);
  ...
  const Grid3x3 = createLucideIcon("grid-3x3", __iconNode$eg);
  ...
  const GripHorizontal = createLucideIcon("grip-horizontal", __iconNode$ef);
  ...
  const GripVertical = createLucideIcon("grip-vertical", __iconNode$ee);
  ...
  const Grip = createLucideIcon("grip", __iconNode$ed);
  ...
  const Group = createLucideIcon("group", __iconNode$ec);
  ...
  const Guitar = createLucideIcon("guitar", __iconNode$eb);
  ...
  const Ham = createLucideIcon("ham", __iconNode$ea);
  ...
  const Hamburger = createLucideIcon("hamburger", __iconNode$e9);
  ...
  const Hammer = createLucideIcon("hammer", __iconNode$e8);
  ...
  const HandCoins = createLucideIcon("hand-coins", __iconNode$e7);
  ...
  const HandFist = createLucideIcon("hand-fist", __iconNode$e6);
  ...
  const HandGrab = createLucideIcon("hand-grab", __iconNode$e5);
  ...
  const HandHeart = createLucideIcon("hand-heart", __iconNode$e4);
  ...
  const HandHelping = createLucideIcon("hand-helping", __iconNode$e3);
  ...
  const HandMetal = createLucideIcon("hand-metal", __iconNode$e2);
  ...
  const HandPlatter = createLucideIcon("hand-platter", __iconNode$e1);
  ...
  const Hand = createLucideIcon("hand", __iconNode$e0);
  ...
  const Handbag = createLucideIcon("handbag", __iconNode$d$);
  ...
  const Handshake = createLucideIcon("handshake", __iconNode$d_);
  ...
  const HardDriveUpload = createLucideIcon("hard-drive-upload", __iconNode$dY);
  ...
  const Hash = createLucideIcon("hash", __iconNode$dV);
  ...
  const HatGlasses = createLucideIcon("hat-glasses", __iconNode$dU);
  ...
  const Haze = createLucideIcon("haze", __iconNode$dT);
  ...
  const Hd = createLucideIcon("hd", __iconNode$dS);
  ...
  const HdmiPort = createLucideIcon("hdmi-port", __iconNode$dR);
  ...
  const Heading1 = createLucideIcon("heading-1", __iconNode$dQ);
  ...
  const Heading2 = createLucideIcon("heading-2", __iconNode$dP);
  ...
  const Heading3 = createLucideIcon("heading-3", __iconNode$dO);
  ...
  const Heading4 = createLucideIcon("heading-4", __iconNode$dN);
  ...
  const Heading5 = createLucideIcon("heading-5", __iconNode$dM);
  ...
  const Heading6 = createLucideIcon("heading-6", __iconNode$dL);
  ...
  const Heading = createLucideIcon("heading", __iconNode$dK);
  ...
  const HeadphoneOff = createLucideIcon("headphone-off", __iconNode$dJ);
  ...
  const Headphones = createLucideIcon("headphones", __iconNode$dI);
  ...
  const Headset = createLucideIcon("headset", __iconNode$dH);
  ...
  const HeartCrack = createLucideIcon("heart-crack", __iconNode$dG);
  ...
  const HeartHandshake = createLucideIcon("heart-handshake", __iconNode$dF);
  ...
  const HeartMinus = createLucideIcon("heart-minus", __iconNode$dE);
  ...
  const HeartOff = createLucideIcon("heart-off", __iconNode$dD);
  ...
  const HeartPlus = createLucideIcon("heart-plus", __iconNode$dC);
  ...
  const HeartPulse = createLucideIcon("heart-pulse", __iconNode$dB);
  ...
  const Heart = createLucideIcon("heart", __iconNode$dA);
  ...
  const Heater = createLucideIcon("heater", __iconNode$dz);
  ...
  const Helicopter = createLucideIcon("helicopter", __iconNode$dy);
  ...
  const Highlighter = createLucideIcon("highlighter", __iconNode$dw);
  ...
  const History = createLucideIcon("history", __iconNode$dv);
  ...
  const HopOff = createLucideIcon("hop-off", __iconNode$du);
  ...
  const Hop = createLucideIcon("hop", __iconNode$dt);
  ...
  const Hospital = createLucideIcon("hospital", __iconNode$ds);
  ...
  const Hotel = createLucideIcon("hotel", __iconNode$dr);
  ...
  const Hourglass = createLucideIcon("hourglass", __iconNode$dq);
  ...
  const HouseHeart = createLucideIcon("house-heart", __iconNode$dp);
  ...
  const HousePlus = createLucideIcon("house-plus", __iconNode$dn);
  ...
  const HouseWifi = createLucideIcon("house-wifi", __iconNode$dm);
  ...
  const House = createLucideIcon("house", __iconNode$dl);
  ...
  const IceCreamBowl = createLucideIcon("ice-cream-bowl", __iconNode$dk);
  ...
  const IceCreamCone = createLucideIcon("ice-cream-cone", __iconNode$dj);
  ...
  const IdCardLanyard = createLucideIcon("id-card-lanyard", __iconNode$di);
  ...
  const IdCard = createLucideIcon("id-card", __iconNode$dh);
  ...
  const ImageDown = createLucideIcon("image-down", __iconNode$dg);
  ...
  const ImageOff = createLucideIcon("image-off", __iconNode$de);
  ...
  const ImagePlay = createLucideIcon("image-play", __iconNode$dd);
  ...
  const ImagePlus = createLucideIcon("image-plus", __iconNode$dc);
  ...
  const ImageUp = createLucideIcon("image-up", __iconNode$db);
  ...
  const ImageUpscale = createLucideIcon("image-upscale", __iconNode$da);
  ...
  const Image = createLucideIcon("image", __iconNode$d9);
  ...
  const Images = createLucideIcon("images", __iconNode$d8);
  ...
  const Import = createLucideIcon("import", __iconNode$d7);
  ...
  const Inbox = createLucideIcon("inbox", __iconNode$d6);
  ...
  const IndianRupee = createLucideIcon("indian-rupee", __iconNode$d5);

  const __iconNode$d4 = [
    ["path", { d: "M6 16c5 0 7-8 12-8a4 4 0 0 1 0 8c-5 0-7-8-12-8a4 4 0 1 0 0 8", key: "18ogeb" }]
  ];
  const Infinity = createLucideIcon("infinity", __iconNode$d4);
  ...
  const Info = createLucideIcon("info", __iconNode$d3);
  ...
  const InspectionPanel = createLucideIcon("inspection-panel", __iconNode$d2);
  ...
  const Instagram = createLucideIcon("instagram", __iconNode$d1);
  ...
  const Italic = createLucideIcon("italic", __iconNode$d0);

  const __iconNode$c$ = [
    ["path", { d: "m16 14 4 4-4 4", key: "hkso8o" }],
    ["path", { d: "M20 10a8 8 0 1 0-8 8h8", key: "1bik7b" }]
  ];
  const IterationCcw = createLucideIcon("iteration-ccw", __iconNode$c$);

  const __iconNode$c_ = [
    ["path", { d: "M4 10a8 8 0 1 1 8 8H4", key: "svv66n" }],
    ["path", { d: "m8 22-4-4 4-4", key: "6g7gki" }]
  ];
  const IterationCw = createLucideIcon("iteration-cw", __iconNode$c_);
  ...
  const JapaneseYen = createLucideIcon("japanese-yen", __iconNode$cZ);
  ...
  const Joystick = createLucideIcon("joystick", __iconNode$cY);
  ...
  const Kanban = createLucideIcon("kanban", __iconNode$cX);
  ...
  const Kayak = createLucideIcon("kayak", __iconNode$cW);
  ...
  const KeySquare = createLucideIcon("key-square", __iconNode$cU);
  ...
  const Key = createLucideIcon("key", __iconNode$cT);
  ...
  const KeyboardMusic = createLucideIcon("keyboard-music", __iconNode$cS);
  ...
  const KeyboardOff = createLucideIcon("keyboard-off", __iconNode$cR);
  ...
  const Keyboard = createLucideIcon("keyboard", __iconNode$cQ);
  ...
  const LampCeiling = createLucideIcon("lamp-ceiling", __iconNode$cP);
  ...
  const LampDesk = createLucideIcon("lamp-desk", __iconNode$cO);
  ...
  const LampFloor = createLucideIcon("lamp-floor", __iconNode$cN);
  ...
  const LampWallDown = createLucideIcon("lamp-wall-down", __iconNode$cM);
  ...
  const LampWallUp = createLucideIcon("lamp-wall-up", __iconNode$cL);
  ...
  const Lamp = createLucideIcon("lamp", __iconNode$cK);
  ...
  const Languages = createLucideIcon("languages", __iconNode$cH);
  ...
  const LaptopMinimalCheck = createLucideIcon("laptop-minimal-check", __iconNode$cG);

  const __iconNode$cF = [
    ["rect", { width: "18", height: "12", x: "3", y: "4", rx: "2", ry: "2", key: "1qhy41" }],
    ["line", { x1: "2", x2: "22", y1: "20", y2: "20", key: "ni3hll" }]
  ];
  const LaptopMinimal = createLucideIcon("laptop-minimal", __iconNode$cF);
  ...
  const Laptop = createLucideIcon("laptop", __iconNode$cE);
  ...
  const Lasso = createLucideIcon("lasso", __iconNode$cC);
  ...
  const Laugh = createLucideIcon("laugh", __iconNode$cB);
  ...
  const Layers2 = createLucideIcon("layers-2", __iconNode$cA);
  ...
  const LayersPlus = createLucideIcon("layers-plus", __iconNode$cz);
  ...
  const Layers = createLucideIcon("layers", __iconNode$cy);
  ...
  const LayoutDashboard = createLucideIcon("layout-dashboard", __iconNode$cx);
  ...
  const LayoutGrid = createLucideIcon("layout-grid", __iconNode$cw);
  ...
  const LayoutPanelTop = createLucideIcon("layout-panel-top", __iconNode$ct);
  ...
  const LayoutTemplate = createLucideIcon("layout-template", __iconNode$cs);
  ...
  const Leaf = createLucideIcon("leaf", __iconNode$cr);
  ...
  const LeafyGreen = createLucideIcon("leafy-green", __iconNode$cq);
  ...
  const Lectern = createLucideIcon("lectern", __iconNode$cp);
  ...
  const LibraryBig = createLucideIcon("library-big", __iconNode$co);
  ...
  const Library = createLucideIcon("library", __iconNode$cn);
  ...
  const LifeBuoy = createLucideIcon("life-buoy", __iconNode$cm);
  ...
  const Ligature = createLucideIcon("ligature", __iconNode$cl);
  ...
  const LightbulbOff = createLucideIcon("lightbulb-off", __iconNode$ck);
  ...
  const Lightbulb = createLucideIcon("lightbulb", __iconNode$cj);
  ...
  const LineSquiggle = createLucideIcon("line-squiggle", __iconNode$ci);
  ...
  const Link2Off = createLucideIcon("link-2-off", __iconNode$ch);
  ...
  const Link2 = createLucideIcon("link-2", __iconNode$cg);

  const __iconNode$cf = [
    ["path", { d: "M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71", key: "1cjeqo" }],
    ["path", { d: "M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71", key: "19qd67" }]
  ];
  const Link = createLucideIcon("link", __iconNode$cf);
  ...
  const Linkedin = createLucideIcon("linkedin", __iconNode$ce);
  ...
  const ListCheck = createLucideIcon("list-check", __iconNode$cd);
  ...
  const ListChecks = createLucideIcon("list-checks", __iconNode$cc);
  ...
  const ListChevronsDownUp = createLucideIcon("list-chevrons-down-up", __iconNode$cb);
  ...
  const ListChevronsUpDown = createLucideIcon("list-chevrons-up-down", __iconNode$ca);
  ...
  const ListCollapse = createLucideIcon("list-collapse", __iconNode$c9);
  ...
  const ListEnd = createLucideIcon("list-end", __iconNode$c8);
  ...
  const ListFilterPlus = createLucideIcon("list-filter-plus", __iconNode$c7);
  ...
  const ListFilter = createLucideIcon("list-filter", __iconNode$c6);
  ...
  const ListIndentDecrease = createLucideIcon("list-indent-decrease", __iconNode$c5);
  ...
  const ListIndentIncrease = createLucideIcon("list-indent-increase", __iconNode$c4);
  ...
  const ListMusic = createLucideIcon("list-music", __iconNode$c2);
  ...
  const ListOrdered = createLucideIcon("list-ordered", __iconNode$c1);
  ...
  const ListPlus = createLucideIcon("list-plus", __iconNode$c0);
  ...
  const ListRestart = createLucideIcon("list-restart", __iconNode$b$);
  ...
  const ListStart = createLucideIcon("list-start", __iconNode$b_);
  ...
  const ListTodo = createLucideIcon("list-todo", __iconNode$bZ);
  ...
  const ListTree = createLucideIcon("list-tree", __iconNode$bY);
  ...
  const ListVideo = createLucideIcon("list-video", __iconNode$bX);
  ...
  const ListX = createLucideIcon("list-x", __iconNode$bW);
  ...
  const List = createLucideIcon("list", __iconNode$bV);
  ...
  const LoaderPinwheel = createLucideIcon("loader-pinwheel", __iconNode$bU);
  ...
  const Loader = createLucideIcon("loader", __iconNode$bS);
  ...
  const LocateFixed = createLucideIcon("locate-fixed", __iconNode$bR);
  ...
  const Locate = createLucideIcon("locate", __iconNode$bP);
  ...
  const LockKeyholeOpen = createLucideIcon("lock-keyhole-open", __iconNode$bO);
  ...
  const LockKeyhole = createLucideIcon("lock-keyhole", __iconNode$bN);

  const __iconNode$bM = [
    ["rect", { width: "18", height: "11", x: "3", y: "11", rx: "2", ry: "2", key: "1w4ew1" }],
    ["path", { d: "M7 11V7a5 5 0 0 1 9.9-1", key: "1mm8w8" }]
  ];
  const LockOpen = createLucideIcon("lock-open", __iconNode$bM);

  const __iconNode$bL = [
    ["rect", { width: "18", height: "11", x: "3", y: "11", rx: "2", ry: "2", key: "1w4ew1" }],
    ["path", { d: "M7 11V7a5 5 0 0 1 10 0v4", key: "fwvmzm" }]
  ];
  const Lock = createLucideIcon("lock", __iconNode$bL);
  ...
  const LogIn = createLucideIcon("log-in", __iconNode$bK);
  ...
  const LogOut = createLucideIcon("log-out", __iconNode$bJ);
  ...
  const Logs = createLucideIcon("logs", __iconNode$bI);
  ...
  const Lollipop = createLucideIcon("lollipop", __iconNode$bH);
  ...
  const Luggage = createLucideIcon("luggage", __iconNode$bG);
  ...
  const Magnet = createLucideIcon("magnet", __iconNode$bF);
  ...
  const MailMinus = createLucideIcon("mail-minus", __iconNode$bD);
  ...
  const MailOpen = createLucideIcon("mail-open", __iconNode$bC);
  ...
  const MailQuestionMark = createLucideIcon("mail-question-mark", __iconNode$bB);
  ...
  const MailSearch = createLucideIcon("mail-search", __iconNode$bz);
  ...
  const MailWarning = createLucideIcon("mail-warning", __iconNode$by);

  const __iconNode$bx = [
    ["path", { d: "m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7", key: "132q7q" }],
    ["rect", { x: "2", y: "4", width: "20", height: "16", rx: "2", key: "izxlao" }]
  ];
  const Mail = createLucideIcon("mail", __iconNode$bx);
  ...
  const Mailbox = createLucideIcon("mailbox", __iconNode$bv);
  ...
  const Mails = createLucideIcon("mails", __iconNode$bu);
  ...
  const MapMinus = createLucideIcon("map-minus", __iconNode$bt);
  ...
  const MapPinCheckInside = createLucideIcon("map-pin-check-inside", __iconNode$bs);
  ...
  const MapPinCheck = createLucideIcon("map-pin-check", __iconNode$br);
  ...
  const MapPinHouse = createLucideIcon("map-pin-house", __iconNode$bq);
  ...
  const MapPinMinusInside = createLucideIcon("map-pin-minus-inside", __iconNode$bp);
  ...
  const MapPinMinus = createLucideIcon("map-pin-minus", __iconNode$bo);
  ...
  const MapPinOff = createLucideIcon("map-pin-off", __iconNode$bn);
  ...
  const MapPinPlusInside = createLucideIcon("map-pin-plus-inside", __iconNode$bm);
  ...
  const MapPinPlus = createLucideIcon("map-pin-plus", __iconNode$bk);
  ...
  const MapPinXInside = createLucideIcon("map-pin-x-inside", __iconNode$bj);
  ...
  const MapPinX = createLucideIcon("map-pin-x", __iconNode$bi);
  ...
  const MapPin = createLucideIcon("map-pin", __iconNode$bh);
  ...
  const MapPinned = createLucideIcon("map-pinned", __iconNode$bg);
  ...
  const MapPlus = createLucideIcon("map-plus", __iconNode$bf);
  ...
  const Map = createLucideIcon("map", __iconNode$be);
  ...
  const MarsStroke = createLucideIcon("mars-stroke", __iconNode$bd);
  ...
  const Mars = createLucideIcon("mars", __iconNode$bc);
  ...
  const Martini = createLucideIcon("martini", __iconNode$bb);
  ...
  const Maximize2 = createLucideIcon("maximize-2", __iconNode$ba);
  ...
  const Maximize = createLucideIcon("maximize", __iconNode$b9);
  ...
  const Medal = createLucideIcon("medal", __iconNode$b8);
  ...
  const MegaphoneOff = createLucideIcon("megaphone-off", __iconNode$b7);
  ...
  const Megaphone = createLucideIcon("megaphone", __iconNode$b6);
  ...
  const Meh = createLucideIcon("meh", __iconNode$b5);
  ...
  const Menu = createLucideIcon("menu", __iconNode$b3);
  ...
  const Merge = createLucideIcon("merge", __iconNode$b2);
  ...
  const MessageCircleCode = createLucideIcon("message-circle-code", __iconNode$b1);
  ...
  const MessageCircleDashed = createLucideIcon("message-circle-dashed", __iconNode$b0);
  ...
  const MessageCircleHeart = createLucideIcon("message-circle-heart", __iconNode$a$);
  ...
  const MessageCircleMore = createLucideIcon("message-circle-more", __iconNode$a_);
  ...
  const MessageCircleOff = createLucideIcon("message-circle-off", __iconNode$aZ);
  ...
  const MessageCirclePlus = createLucideIcon("message-circle-plus", __iconNode$aY);
  ...
  const MessageCircleQuestionMark = createLucideIcon("message-circle-question-mark", __iconNode$aX);
  ...
  const MessageCircleReply = createLucideIcon("message-circle-reply", __iconNode$aW);
  ...
  const MessageCircleWarning = createLucideIcon("message-circle-warning", __iconNode$aV);
  ...
  const MessageCircleX = createLucideIcon("message-circle-x", __iconNode$aU);
  ...
  const MessageCircle = createLucideIcon("message-circle", __iconNode$aT);
  ...
  const MessageSquareCode = createLucideIcon("message-square-code", __iconNode$aS);
  ...
  const MessageSquareDashed = createLucideIcon("message-square-dashed", __iconNode$aR);
  ...
  const MessageSquareDiff = createLucideIcon("message-square-diff", __iconNode$aQ);
  ...
  const MessageSquareDot = createLucideIcon("message-square-dot", __iconNode$aP);
  ...
  const MessageSquareHeart = createLucideIcon("message-square-heart", __iconNode$aO);
  ...
  const MessageSquareLock = createLucideIcon("message-square-lock", __iconNode$aN);
  ...
  const MessageSquareOff = createLucideIcon("message-square-off", __iconNode$aM);
  ...
  const MessageSquarePlus = createLucideIcon("message-square-plus", __iconNode$aK);
  ...
  const MessageSquareQuote = createLucideIcon("message-square-quote", __iconNode$aJ);
  ...
  const MessageSquareReply = createLucideIcon("message-square-reply", __iconNode$aI);
  ...
  const MessageSquareText = createLucideIcon("message-square-text", __iconNode$aH);
  ...
  const MessageSquareWarning = createLucideIcon("message-square-warning", __iconNode$aF);
  ...
  const MessageSquareX = createLucideIcon("message-square-x", __iconNode$aE);
  ...
  const MessageSquare = createLucideIcon("message-square", __iconNode$aD);
  ...
  const MessagesSquare = createLucideIcon("messages-square", __iconNode$aC);
  ...
  const MicOff = createLucideIcon("mic-off", __iconNode$aB);
  ...
  const Mic = createLucideIcon("mic", __iconNode$aA);
  ...
  const Microchip = createLucideIcon("microchip", __iconNode$ay);
  ...
  const Microscope = createLucideIcon("microscope", __iconNode$ax);
  ...
  const Microwave = createLucideIcon("microwave", __iconNode$aw);
  ...
  const Milestone = createLucideIcon("milestone", __iconNode$av);
  ...
  const MilkOff = createLucideIcon("milk-off", __iconNode$au);
  ...
  const Milk = createLucideIcon("milk", __iconNode$at);
  ...
  const Minimize2 = createLucideIcon("minimize-2", __iconNode$as);
  ...
  const Minimize = createLucideIcon("minimize", __iconNode$ar);
  ...
  const MonitorCheck = createLucideIcon("monitor-check", __iconNode$aq);
  ...
  const MonitorCloud = createLucideIcon("monitor-cloud", __iconNode$ao);
  ...
  const MonitorCog = createLucideIcon("monitor-cog", __iconNode$an);
  ...
  const MonitorDot = createLucideIcon("monitor-dot", __iconNode$am);
  ...
  const MonitorDown = createLucideIcon("monitor-down", __iconNode$al);
  ...
  const MonitorOff = createLucideIcon("monitor-off", __iconNode$ak);
  ...
  const MonitorPause = createLucideIcon("monitor-pause", __iconNode$aj);
  ...
  const MonitorPlay = createLucideIcon("monitor-play", __iconNode$ai);
  ...
  const MonitorSmartphone = createLucideIcon("monitor-smartphone", __iconNode$ah);
  ...
  const MonitorSpeaker = createLucideIcon("monitor-speaker", __iconNode$ag);
  ...
  const MonitorStop = createLucideIcon("monitor-stop", __iconNode$af);
  ...
  const MonitorX = createLucideIcon("monitor-x", __iconNode$ae);
  ...
  const MoonStar = createLucideIcon("moon-star", __iconNode$ac);
  ...
  const Moon = createLucideIcon("moon", __iconNode$aa);
  ...
  const Motorbike = createLucideIcon("motorbike", __iconNode$a9);
  ...
  const MountainSnow = createLucideIcon("mountain-snow", __iconNode$a8);

  const __iconNode$a7 = [["path", { d: "m8 3 4 8 5-5 5 15H2L8 3z", key: "otkl63" }]];
  const Mountain = createLucideIcon("mountain", __iconNode$a7);
  ...
  const MouseOff = createLucideIcon("mouse-off", __iconNode$a6);
  ...
  const MousePointer2 = createLucideIcon("mouse-pointer-2", __iconNode$a4);
  ...
  const MousePointerBan = createLucideIcon("mouse-pointer-ban", __iconNode$a3);
  ...
  const MousePointerClick = createLucideIcon("mouse-pointer-click", __iconNode$a2);
  ...
  const MousePointer = createLucideIcon("mouse-pointer", __iconNode$a1);

  const __iconNode$a0 = [
    ["rect", { x: "5", y: "2", width: "14", height: "20", rx: "7", key: "11ol66" }],
    ["path", { d: "M12 6v4", key: "16clxf" }]
  ];
  const Mouse = createLucideIcon("mouse", __iconNode$a0);
  ...
  const Move3d = createLucideIcon("move-3d", __iconNode$9$);
  ...
  const MoveDiagonal2 = createLucideIcon("move-diagonal-2", __iconNode$9_);
  ...
  const MoveDiagonal = createLucideIcon("move-diagonal", __iconNode$9Z);

  const __iconNode$9Y = [
    ["path", { d: "M11 19H5V13", key: "1akmht" }],
    ["path", { d: "M19 5L5 19", key: "72u4yj" }]
  ];
  const MoveDownLeft = createLucideIcon("move-down-left", __iconNode$9Y);

  const __iconNode$9X = [
    ["path", { d: "M19 13V19H13", key: "10vkzq" }],
    ["path", { d: "M5 5L19 19", key: "5zm2fv" }]
  ];
  const MoveDownRight = createLucideIcon("move-down-right", __iconNode$9X);

  const __iconNode$9W = [
    ["path", { d: "M8 18L12 22L16 18", key: "cskvfv" }],
    ["path", { d: "M12 2V22", key: "r89rzk" }]
  ];
  const MoveDown = createLucideIcon("move-down", __iconNode$9W);
  ...
  const MoveHorizontal = createLucideIcon("move-horizontal", __iconNode$9V);

  const __iconNode$9U = [
    ["path", { d: "M6 8L2 12L6 16", key: "kyvwex" }],
    ["path", { d: "M2 12H22", key: "1m8cig" }]
  ];
  const MoveLeft = createLucideIcon("move-left", __iconNode$9U);

  const __iconNode$9T = [
    ["path", { d: "M18 8L22 12L18 16", key: "1r0oui" }],
    ["path", { d: "M2 12H22", key: "1m8cig" }]
  ];
  const MoveRight = createLucideIcon("move-right", __iconNode$9T);

  const __iconNode$9S = [
    ["path", { d: "M5 11V5H11", key: "3q78g9" }],
    ["path", { d: "M5 5L19 19", key: "5zm2fv" }]
  ];
  const MoveUpLeft = createLucideIcon("move-up-left", __iconNode$9S);

  const __iconNode$9R = [
    ["path", { d: "M8 6L12 2L16 6", key: "1yvkyx" }],
    ["path", { d: "M12 2V22", key: "r89rzk" }]
  ];
  const MoveUp = createLucideIcon("move-up", __iconNode$9R);
  ...
  const Move = createLucideIcon("move", __iconNode$9P);
  ...
  const Music2 = createLucideIcon("music-2", __iconNode$9N);

  const __iconNode$9M = [
    ["circle", { cx: "12", cy: "18", r: "4", key: "m3r9ws" }],
    ["path", { d: "M16 18V2", key: "40x2m5" }]
  ];
  const Music3 = createLucideIcon("music-3", __iconNode$9M);
  ...
  const Music4 = createLucideIcon("music-4", __iconNode$9L);
  ...
  const Music = createLucideIcon("music", __iconNode$9K);
  ...
  const Navigation2Off = createLucideIcon("navigation-2-off", __iconNode$9J);

  const __iconNode$9I = [
    ["polygon", { points: "12 2 19 21 12 17 5 21 12 2", key: "x8c0qg" }]
  ];
  const Navigation2 = createLucideIcon("navigation-2", __iconNode$9I);
  ...
  const NavigationOff = createLucideIcon("navigation-off", __iconNode$9H);

  const __iconNode$9G = [
    ["polygon", { points: "3 11 22 2 13 21 11 13 3 11", key: "1ltx0t" }]
  ];
  const Navigation = createLucideIcon("navigation", __iconNode$9G);
  ...
  const Network = createLucideIcon("network", __iconNode$9F);
  ...
  const Newspaper = createLucideIcon("newspaper", __iconNode$9E);
  ...
  const NonBinary = createLucideIcon("non-binary", __iconNode$9C);
  ...
  const NotebookTabs = createLucideIcon("notebook-tabs", __iconNode$9A);
  ...
  const NotebookText = createLucideIcon("notebook-text", __iconNode$9z);
  ...
  const Notebook = createLucideIcon("notebook", __iconNode$9y);
  ...
  const NotepadText = createLucideIcon("notepad-text", __iconNode$9w);
  ...
  const NutOff = createLucideIcon("nut-off", __iconNode$9v);
  ...
  const Nut = createLucideIcon("nut", __iconNode$9u);
  ...
  const OctagonAlert = createLucideIcon("octagon-alert", __iconNode$9t);
  ...
  const OctagonMinus = createLucideIcon("octagon-minus", __iconNode$9s);
  ...
  const OctagonPause = createLucideIcon("octagon-pause", __iconNode$9r);
  ...
  const OctagonX = createLucideIcon("octagon-x", __iconNode$9q);
  ...
  const Octagon = createLucideIcon("octagon", __iconNode$9p);
  ...
  const Omega = createLucideIcon("omega", __iconNode$9o);

  const __iconNode$9n = [
    ["path", { d: "M3 3h6l6 18h6", key: "ph9rgk" }],
    ["path", { d: "M14 3h7", key: "16f0ms" }]
  ];
  const Option = createLucideIcon("option", __iconNode$9n);
  ...
  const Orbit = createLucideIcon("orbit", __iconNode$9m);
  ...
  const Origami = createLucideIcon("origami", __iconNode$9l);
  ...
  const PackageCheck = createLucideIcon("package-check", __iconNode$9j);
  ...
  const PackageMinus = createLucideIcon("package-minus", __iconNode$9i);
  ...
  const PackageSearch = createLucideIcon("package-search", __iconNode$9f);
  ...
  const PackageX = createLucideIcon("package-x", __iconNode$9e);
  ...
  const Package = createLucideIcon("package", __iconNode$9d);
  ...
  const PaintBucket = createLucideIcon("paint-bucket", __iconNode$9c);
  ...
  const PaintRoller = createLucideIcon("paint-roller", __iconNode$9b);
  ...
  const PaintbrushVertical = createLucideIcon("paintbrush-vertical", __iconNode$9a);
  ...
  const Paintbrush = createLucideIcon("paintbrush", __iconNode$99);
  ...
  const Palette = createLucideIcon("palette", __iconNode$98);
  ...
  const Panda = createLucideIcon("panda", __iconNode$97);
  ...
  const PanelBottomClose = createLucideIcon("panel-bottom-close", __iconNode$96);
  ...
  const PanelBottomDashed = createLucideIcon("panel-bottom-dashed", __iconNode$95);
  ...
  const PanelBottomOpen = createLucideIcon("panel-bottom-open", __iconNode$94);

  const __iconNode$93 = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "M3 15h18", key: "5xshup" }]
  ];
  const PanelBottom = createLucideIcon("panel-bottom", __iconNode$93);
  ...
  const PanelLeftClose = createLucideIcon("panel-left-close", __iconNode$92);
  ...
  const PanelLeftDashed = createLucideIcon("panel-left-dashed", __iconNode$91);
  ...
  const PanelLeftOpen = createLucideIcon("panel-left-open", __iconNode$90);
  ...
  const PanelLeftRightDashed = createLucideIcon("panel-left-right-dashed", __iconNode$8$);

  const __iconNode$8_ = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "M9 3v18", key: "fh3hqa" }]
  ];
  const PanelLeft = createLucideIcon("panel-left", __iconNode$8_);
  ...
  const PanelRightClose = createLucideIcon("panel-right-close", __iconNode$8Z);
  ...
  const PanelRightDashed = createLucideIcon("panel-right-dashed", __iconNode$8Y);
  ...
  const PanelRightOpen = createLucideIcon("panel-right-open", __iconNode$8X);

  const __iconNode$8W = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "M15 3v18", key: "14nvp0" }]
  ];
  const PanelRight = createLucideIcon("panel-right", __iconNode$8W);
  ...
  const PanelTopBottomDashed = createLucideIcon("panel-top-bottom-dashed", __iconNode$8V);
  ...
  const PanelTopClose = createLucideIcon("panel-top-close", __iconNode$8U);
  ...
  const PanelTopDashed = createLucideIcon("panel-top-dashed", __iconNode$8T);
  ...
  const PanelTopOpen = createLucideIcon("panel-top-open", __iconNode$8S);
  ...
  const PanelsLeftBottom = createLucideIcon("panels-left-bottom", __iconNode$8Q);
  ...
  const PanelsRightBottom = createLucideIcon("panels-right-bottom", __iconNode$8P);
  ...
  const Paperclip = createLucideIcon("paperclip", __iconNode$8O);
  ...
  const Parentheses = createLucideIcon("parentheses", __iconNode$8M);
  ...
  const ParkingMeter = createLucideIcon("parking-meter", __iconNode$8L);
  ...
  const PartyPopper = createLucideIcon("party-popper", __iconNode$8K);

  const __iconNode$8J = [
    ["rect", { x: "14", y: "3", width: "5", height: "18", rx: "1", key: "kaeet6" }],
    ["rect", { x: "5", y: "3", width: "5", height: "18", rx: "1", key: "1wsw3u" }]
  ];
  const Pause = createLucideIcon("pause", __iconNode$8J);
  ...
  const PawPrint = createLucideIcon("paw-print", __iconNode$8I);
  ...
  const PcCase = createLucideIcon("pc-case", __iconNode$8H);
  ...
  const PenLine = createLucideIcon("pen-line", __iconNode$8G);
  ...
  const PenOff = createLucideIcon("pen-off", __iconNode$8F);
  ...
  const PenTool = createLucideIcon("pen-tool", __iconNode$8E);
  ...
  const Pen = createLucideIcon("pen", __iconNode$8D);
  ...
  const PencilLine = createLucideIcon("pencil-line", __iconNode$8C);
  ...
  const PencilOff = createLucideIcon("pencil-off", __iconNode$8B);
  ...
  const PencilRuler = createLucideIcon("pencil-ruler", __iconNode$8A);
  ...
  const Pencil = createLucideIcon("pencil", __iconNode$8z);
  ...
  const Pentagon = createLucideIcon("pentagon", __iconNode$8y);
  ...
  const Percent = createLucideIcon("percent", __iconNode$8x);
  ...
  const PersonStanding = createLucideIcon("person-standing", __iconNode$8w);
  ...
  const PhilippinePeso = createLucideIcon("philippine-peso", __iconNode$8v);
  ...
  const PhoneCall = createLucideIcon("phone-call", __iconNode$8u);
  ...
  const PhoneForwarded = createLucideIcon("phone-forwarded", __iconNode$8t);
  ...
  const PhoneIncoming = createLucideIcon("phone-incoming", __iconNode$8s);
  ...
  const PhoneMissed = createLucideIcon("phone-missed", __iconNode$8r);
  ...
  const PhoneOff = createLucideIcon("phone-off", __iconNode$8q);
  ...
  const PhoneOutgoing = createLucideIcon("phone-outgoing", __iconNode$8p);
  ...
  const Phone = createLucideIcon("phone", __iconNode$8o);
  ...
  const Pi = createLucideIcon("pi", __iconNode$8n);
  ...
  const Piano = createLucideIcon("piano", __iconNode$8m);
  ...
  const PictureInPicture2 = createLucideIcon("picture-in-picture-2", __iconNode$8k);
  ...
  const PictureInPicture = createLucideIcon("picture-in-picture", __iconNode$8j);
  ...
  const PiggyBank = createLucideIcon("piggy-bank", __iconNode$8i);
  ...
  const PilcrowLeft = createLucideIcon("pilcrow-left", __iconNode$8h);
  ...
  const PilcrowRight = createLucideIcon("pilcrow-right", __iconNode$8g);
  ...
  const Pilcrow = createLucideIcon("pilcrow", __iconNode$8f);
  ...
  const PillBottle = createLucideIcon("pill-bottle", __iconNode$8e);
  ...
  const Pill = createLucideIcon("pill", __iconNode$8d);
  ...
  const PinOff = createLucideIcon("pin-off", __iconNode$8c);
  ...
  const Pin = createLucideIcon("pin", __iconNode$8b);
  ...
  const Pipette = createLucideIcon("pipette", __iconNode$8a);
  ...
  const Pizza = createLucideIcon("pizza", __iconNode$89);
  ...
  const PlaneLanding = createLucideIcon("plane-landing", __iconNode$88);
  ...
  const PlaneTakeoff = createLucideIcon("plane-takeoff", __iconNode$87);
  ...
  const Plane = createLucideIcon("plane", __iconNode$86);
  ...
  const Play = createLucideIcon("play", __iconNode$85);
  ...
  const Plug2 = createLucideIcon("plug-2", __iconNode$84);
  ...
  const PlugZap = createLucideIcon("plug-zap", __iconNode$83);
  ...
  const Plug = createLucideIcon("plug", __iconNode$82);

  const __iconNode$81 = [
    ["path", { d: "M5 12h14", key: "1ays0h" }],
    ["path", { d: "M12 5v14", key: "s699le" }]
  ];
  const Plus = createLucideIcon("plus", __iconNode$81);

  const __iconNode$80 = [
    ["path", { d: "M20 3a2 2 0 0 1 2 2v6a1 1 0 0 1-20 0V5a2 2 0 0 1 2-2z", key: "1uodqw" }],
    ["path", { d: "m8 10 4 4 4-4", key: "1mxd5q" }]
  ];
  const Pocket = createLucideIcon("pocket", __iconNode$80);
  ...
  const Podcast = createLucideIcon("podcast", __iconNode$7_);
  ...
  const PointerOff = createLucideIcon("pointer-off", __iconNode$7Z);
  ...
  const Popcorn = createLucideIcon("popcorn", __iconNode$7X);
  ...
  const PoundSterling = createLucideIcon("pound-sterling", __iconNode$7V);
  ...
  const PowerOff = createLucideIcon("power-off", __iconNode$7U);

  const __iconNode$7T = [
    ["path", { d: "M12 2v10", key: "mnfbl" }],
    ["path", { d: "M18.4 6.6a9 9 0 1 1-12.77.04", key: "obofu9" }]
  ];
  const Power = createLucideIcon("power", __iconNode$7T);
  ...
  const Presentation = createLucideIcon("presentation", __iconNode$7S);
  ...
  const PrinterCheck = createLucideIcon("printer-check", __iconNode$7R);
  ...
  const PrinterX = createLucideIcon("printer-x", __iconNode$7Q);
  ...
  const Projector = createLucideIcon("projector", __iconNode$7P);
  ...
  const Printer = createLucideIcon("printer", __iconNode$7O);
  ...
  const Radical = createLucideIcon("radical", __iconNode$7G);
  ...
  const Radiation = createLucideIcon("radiation", __iconNode$7F);
  ...
  const Rainbow = createLucideIcon("rainbow", __iconNode$7A);
  ...
  const RailSymbol = createLucideIcon("rail-symbol", __iconNode$7z);
  ...
  const Receipt = createLucideIcon("receipt", __iconNode$7o);
  ...
  const ReceiptTurkishLira = createLucideIcon("receipt-turkish-lira", __iconNode$7n);

  const __iconNode$7m = [
    ["path", { d: "M14 4v16H3a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1z", key: "1m5n7q" }],
    ["circle", { cx: "14", cy: "12", r: "8", key: "1pag6k" }]
  ];
  const RectangleCircle = createLucideIcon("rectangle-circle", __iconNode$7m);
  ...
  const Redo2 = createLucideIcon("redo-2", __iconNode$7h);
  ...
  const RedoDot = createLucideIcon("redo-dot", __iconNode$7g);
  ...
  const Recycle = createLucideIcon("recycle", __iconNode$7f);
  ...
  const RussianRuble = createLucideIcon("russian-ruble", __iconNode$6H);
  ...
  const Sailboat = createLucideIcon("sailboat", __iconNode$6G);
  ...
  const Salad = createLucideIcon("salad", __iconNode$6F);
  ...
  const Ruler = createLucideIcon("ruler", __iconNode$6E);
  ...
  const SaveOff = createLucideIcon("save-off", __iconNode$6z);
  ...
  const SaveAll = createLucideIcon("save-all", __iconNode$6y);
  ...
  const Scan = createLucideIcon("scan", __iconNode$6m);
  ...
  const ScanText = createLucideIcon("scan-text", __iconNode$6l);
  ...
  const ScissorsLineDashed = createLucideIcon("scissors-line-dashed", __iconNode$6k);
  ...
  const School = createLucideIcon("school", __iconNode$6j);
  ...
  const Scroll = createLucideIcon("scroll", __iconNode$6e);
  ...
  const SearchAlert = createLucideIcon("search-alert", __iconNode$6d);
  ...
  const ScrollText = createLucideIcon("scroll-text", __iconNode$6c);
  ...
  const Search = createLucideIcon("search", __iconNode$67);
  ...
  const Section = createLucideIcon("section", __iconNode$66);
  ...
  const Settings2 = createLucideIcon("settings-2", __iconNode$5Y);
  ...
  const Settings = createLucideIcon("settings", __iconNode$5X);
  ...
  const ShieldHalf = createLucideIcon("shield-half", __iconNode$5O);
  ...
  const ShieldEllipsis = createLucideIcon("shield-ellipsis", __iconNode$5N);
  ...
  const Shredder = createLucideIcon("shredder", __iconNode$5x);
  ...
  const Shrimp = createLucideIcon("shrimp", __iconNode$5w);
  ...
  const __iconNode$5o = [["path", { d: "M2 20h.01", key: "4haj6o" }]];
  const SignalZero = createLucideIcon("signal-zero", __iconNode$5o);
  ...
  const Signal = createLucideIcon("signal", __iconNode$5n);
  ...
  const SmilePlus = createLucideIcon("smile-plus", __iconNode$58);

  const __iconNode$57 = [
    ["rect", { width: "14", height: "20", x: "5", y: "2", rx: "2", ry: "2", key: "1yt0o3" }],
    ["path", { d: "M12 18h.01", key: "mhygvu" }]
  ];
  const Smartphone = createLucideIcon("smartphone", __iconNode$57);
  ...
  const Snowflake = createLucideIcon("snowflake", __iconNode$54);
  ...
  const SoapDispenserDroplet = createLucideIcon("soap-dispenser-droplet", __iconNode$53);
  ...
  const Sparkles = createLucideIcon("sparkles", __iconNode$4Z);
  ...
  const Sparkle = createLucideIcon("sparkle", __iconNode$4Y);
  ...
  const Spool = createLucideIcon("spool", __iconNode$4R);
  ...
  const Split = createLucideIcon("split", __iconNode$4Q);
  ...
  const Spotlight = createLucideIcon("spotlight", __iconNode$4P);
  ...
  const SprayCan = createLucideIcon("spray-can", __iconNode$4O);
  ...
  const SquareArrowDown = createLucideIcon("square-arrow-down", __iconNode$4K);
  ...
  const SquareArrowDownRight = createLucideIcon("square-arrow-down-right", __iconNode$4J);
  ...
  const SquareCode = createLucideIcon("square-code", __iconNode$4q);
  ...
  const SquareDashedBottomCode = createLucideIcon("square-dashed-bottom-code", __iconNode$4p);
  ...
  const SquareDashedMousePointer = createLucideIcon("square-dashed-mouse-pointer", __iconNode$4n);
  ...
  const SquareDashedKanban = createLucideIcon("square-dashed-kanban", __iconNode$4m);
  ...
  const SquareLibrary = createLucideIcon("square-library", __iconNode$4f);
  ...
  const SquareKanban = createLucideIcon("square-kanban", __iconNode$4e);
  ...
  const SquareM = createLucideIcon("square-m", __iconNode$4d);
  ...
  const SquareMenu = createLucideIcon("square-menu", __iconNode$4c);
  ...
  const SquarePi = createLucideIcon("square-pi", __iconNode$44);
  ...
  const SquarePilcrow = createLucideIcon("square-pilcrow", __iconNode$43);
  ...
  const SquareStop = createLucideIcon("square-stop", __iconNode$3R);
  ...
  const SquareTerminal = createLucideIcon("square-terminal", __iconNode$3Q);
  ...
  const SquareUserRound = createLucideIcon("square-user-round", __iconNode$3O);
  ...
  const SquaresUnite = createLucideIcon("squares-unite", __iconNode$3J);
  ...
  const SquaresSubtract = createLucideIcon("squares-subtract", __iconNode$3I);
  ...
  const SquircleDashed = createLucideIcon("squircle-dashed", __iconNode$3H);
  ...
  const StarOff = createLucideIcon("star-off", __iconNode$3D);
  ...
  const StarHalf = createLucideIcon("star-half", __iconNode$3C);
  ...
  const Stethoscope = createLucideIcon("stethoscope", __iconNode$3y);
  ...
  const Sticker = createLucideIcon("sticker", __iconNode$3x);
  ...
  const SunMoon = createLucideIcon("sun-moon", __iconNode$3o);
  ...
  const SunMedium = createLucideIcon("sun-medium", __iconNode$3n);
  ...
  const SwatchBook = createLucideIcon("swatch-book", __iconNode$3h);
  ...
  const SwissFranc = createLucideIcon("swiss-franc", __iconNode$3g);
  ...
  const TableProperties = createLucideIcon("table-properties", __iconNode$37);
  ...
  const TableRowsSplit = createLucideIcon("table-rows-split", __iconNode$36);
  ...
  const TableOfContents = createLucideIcon("table-of-contents", __iconNode$35);
  ...
  const Tag = createLucideIcon("tag", __iconNode$31);
  ...
  const Tablets = createLucideIcon("tablets", __iconNode$30);
  ...
  const Telescope = createLucideIcon("telescope", __iconNode$2T);
  ...
  const TentTree = createLucideIcon("tent-tree", __iconNode$2S);
  ...
  const Timer = createLucideIcon("timer", __iconNode$2l);
  ...
  const TimerReset = createLucideIcon("timer-reset", __iconNode$2k);
  ...
  const Tornado = createLucideIcon("tornado", __iconNode$2f);
  ...
  const Toolbox = createLucideIcon("toolbox", __iconNode$2e);
  ...
  const Type = createLucideIcon("type", __iconNode$1E);
  ...
  const TypeOutline = createLucideIcon("type-outline", __iconNode$1D);
  ...
  const UserLock = createLucideIcon("user-lock", __iconNode$1l);
  ...
  const UserMinus = createLucideIcon("user-minus", __iconNode$1k);
  ...
  const Users = createLucideIcon("users", __iconNode$13);
  ...
  const Videotape = createLucideIcon("videotape", __iconNode$R);
  ...
  const Volume2 = createLucideIcon("volume-2", __iconNode$L);
  ...
  const VolumeOff = createLucideIcon("volume-off", __iconNode$K);
  ...
  const ZapOff = createLucideIcon("zap-off", __iconNode$4);
